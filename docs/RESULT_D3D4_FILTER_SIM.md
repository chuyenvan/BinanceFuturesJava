...
Chay dung `docs/PREREG_D3D4_FILTER_SIM.md` (commit `2c8a7a8`). Filter pump-dump POST-HOC (D3
...
- Pre-reg: `docs/PREREG_D3D4_FILTER_SIM.md` (commit `2c8a7a8`).
...
Nguong MOI (docs/RISK_APPETITE.md): maxDD <= 30%/nam, UW <= 200 ngay, khong nam am, quy >= -15%.
