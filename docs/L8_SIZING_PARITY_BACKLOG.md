...
Nguon: `docs/LEAN_GATE_AUDIT.md` muc 4.3/4.4 (doc code), **cong them phep do moi o muc 1.2 duoi day**.
...
**LIVE (so giay C3)**: 8 leg cua MOT tick, do truc tiep trong `docs/L2_PORT_C3.md` muc 4.1
...
1. **Bac do lon KHOP nhau**: sim **2.50%** equity/leg vs live **2.09-3.00%**. Uoc luong
   "~16x" o `docs/LEAN_GATE_AUDIT.md` muc 4.3 la **SAI** — no suy tu cong thuc chu khong do.
