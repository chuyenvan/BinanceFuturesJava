...
Commit file nay PHAI co truoc commit code va truoc moi chan Kaggle (`docs/AGENT_RUNBOOK.md` luat 2).

## 0. Cau hoi + vi sao khac "chan coin"

Bang chung da co (`docs/RESULT_D3D4_FILTER_SIM.md` §2, `docs/RESULT_SELECTOR_LEG_CUT.md` §6):
