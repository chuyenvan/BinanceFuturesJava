...
Doc truoc: `docs/AGENT_RUNBOOK.md`, `docs/C3_BASELINE.md`, `docs/H1_HOLDOUT_PREP.md`,
...
2. **Live thieu time-stop 168h.** Trong C3, `STOP_LOSS_DONE` = time-stop, chiem `TSloss%`
   ...
   `docs/HOLD_TO_DIE.md` da do counterfactual nay.
...
- 🔴 **Bay ve nguon goc**: `docs/H1_HOLDOUT_PREP.md` muc 3 do duoc `CLOSES_1H.bin[t]` = close
...
Pre-reg `docs/PREREG_L1.md` (commit `39c571d`), viet va commit **TRUOC** khi chay.
...
| duong dan | noi dung |
|---|---|
| `docs/L1_SHADOW_C3.md` | file nay |
| `docs/PREREG_L1.md` | pre-reg run doi chung `symbolPred = hang so` (commit `39c571d`) |
