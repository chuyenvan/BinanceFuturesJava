...
Pre-reg: `docs/PREREG_SL_7_TO_3.md` (commit `ce353df`, viet/chot **TRUOC** khi push kernel).
...
`docs/RESULT_INTRADAY_DD.md`). Cua so **DEV 2021-07-01..2025-12-31** (KHONG cham
2026/holdout/242/shadow). Sim chay **Kaggle CPU kernel** (`docs/KAGGLE_SIM.md`), khong chay
