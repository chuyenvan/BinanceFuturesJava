...
> Nen: spec goc `docs/PREREG_CONCENTRATION_SAFETYCAP.md`; ban SIM da verify parity 6/6 tai commit
> `5e82983` (`docs/RESULT_CONCENTRATION_SAFETYCAP.md`); bao cao chan Buoc 0 + 3 cau hoi tai
> `docs/DIAG_CONCENTRATION_SAFETYCAP_LIVE_PORT_BLOCKER.md` (`873c7f5`).
>
