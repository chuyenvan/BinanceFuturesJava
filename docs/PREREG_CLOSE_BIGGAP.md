...
Nguon: brief owner 2026-09-23 + `docs/RESULT_EXIT_FIT.md` (`8f3194f`, `eb4c0de`),
`docs/RESULT_CAPACITY_DIAG.md` (`1416031`), `docs/RESULT_PEAK_CLOSE.md` (`fa26996`),
`docs/PREREG_PEAK_CLOSE.md` (`1fcabe4`).
...
`docs/RESULT_CLOSE_BIGGAP.md`; trung gian: `/home/ubuntu/exitfit/biggap/` (resume duoc; script
