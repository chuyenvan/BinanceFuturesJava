...
- `ledger.csv` chi co lenh vao **3 ngay**: 06/09 (14), 18/09 (25), 19/09 (26).
  07-17/09 = process shadow CHET (xem `docs/RESULT_SHADOW_T170_FIX.md`) ⇒ **khong co du lieu**.
...
(b) **khac config**: lo 06/09 (14 lenh) chay **gate phang 0.008** (truoc fix 18/09, xem
    `docs/SHADOW_EVAL_20260911.md` + `docs/L6_GATE_DYN_FIX.md`); lo 18-19/09 chay gate dyn 1.70
...
## 9. SAN PHAM
- `docs/RESULT_LIVE_VS_SIM.md`: bang so sanh + CI + ket luan (khop/lech, lech o dau, co dau hieu
