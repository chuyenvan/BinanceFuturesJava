...
Ngày: 2026-09-23. Pre-reg: `docs/PREREG_FUNDING_TOPK_LONG.md` (**commit `da76e41`**, amend nguồn
...
| File | Nội dung |
|---|---|
| `docs/PREREG_FUNDING_TOPK_LONG.md` | chốt trước (commit `da76e41`; amend `1203cf7`) |
| `docs/RESULT_FUNDING_TOPK_LONG.md` | file này |
