...
|---|---|---|
| `roadmap_tong.html` | Lộ trình kiểm chứng 6 Bước tổng quan (Bước 0–5) + trạng thái | `docs/plan/ROADMAP.md` |
...
| `system_architecture_all.html` | Toàn hệ thống: 4 node + luồng dữ liệu live→WFO | `docs/PIPELINE_PROVENANCE.md`, `docs/db/aerospike-226.md`, `docs/runbooks/KAGGLE_RULES.md`, `docs/insights/WFO_ROADMAP.md` |
