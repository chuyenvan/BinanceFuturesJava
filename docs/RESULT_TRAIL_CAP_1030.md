...
Chot truoc: `docs/PREREG_TRAIL_CAP_1030.md` (commit `066ec4e`). **Khong doi code** (chi override profile)
...
- `066ec4e` — prereg `docs/PREREG_TRAIL_CAP_1030.md` + profile `profiles/x1_gs_t170_cap1030.properties`.
