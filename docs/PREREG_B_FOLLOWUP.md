...
Nen: docs/RESULT_SL_ADAPTIVE_SWEEP.md §6 — B (adaptive TIME-STOP theo rank) la lever DUY NHAT co
...
vi T170 la incumbent MOI da THANG readjudicate (docs/RESULT_DEV2021_READJUDICATE.md) va PASS hard
