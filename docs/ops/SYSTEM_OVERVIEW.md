...
Nguon chinh: `docs/analysis/WFO_DATAFLOW.md`, `docs/runbooks/AGENT_RUNBOOK.md`, `docs/experiment/C3_BASELINE.md`,
`docs/experiment/X1_EXTEND.md`, `docs/experiment/S1_PROVENANCE.md`, `docs/experiment/L1_SHADOW_C3.md`, `docs/experiment/L5_S1_WARMUP_242.md`,
`docs/runbooks/RISK_APPETITE.md`, `docs/plan/QUEUE.md`.
...
- Nguong RUI RO (khau vi) 2026-09-16/17 (`docs/runbooks/RISK_APPETITE.md`): `maxDD <= 30%/nam`,
...
- Selector ladder **CHUA THIET LAP** (78% uu the nam 2022; rebase 2023 thi C2b THUA) —
  `docs/analysis/SELECTOR_LADDER_Q.md`; AGENT_RUNBOOK.md muc 4.
