...
- `docs/analysis/LEAK_L1_REPORT.md` rho 0.1675, `docs/audit/CI_REAUDIT.md` #8/#9, `docs/analysis/PHASE1_DECISION_SURFACE.md`
  B5/B6, `docs/prereg/PREREG_CI.md`, `docs/prereg/PREREG_GS.md`, moi so DEV/VAL cua C2b: **KHONG** doi.
- ONNX live, gate model: **KHONG** phai convert lai.

Cai **phai** lam:

1. **Sua tai lieu** (bat buoc — dang ghi sai su that):
   - `docs/ops/OI_SCOPE_REPORT.md`: muc 2.1 ("VALIDATION BI, 100%"), muc 2.2 (bang 71.30% dong bi
   ...
   - `docs/experiment/FEAT40_LOOKAHEAD.md`: khoi DINH CHINH dau file (dang ghi "5/5 feature ro ri, 71.30%
