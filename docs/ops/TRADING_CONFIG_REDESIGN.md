...
| `MAX_CONCURRENT` | **DA XOA** (`5f40a90`) | `K1_conc25` va `K2_conc20` = **59,580 giong het K0 tung byte** => **VO HIEU** khi `BREAKER_MODE=OFF` (sim khong he co tran cung lenh dong thoi) | Nut tro. Phep do vo nghia. Xem `docs/prereg/PREREG_K.md`, `docs/ops/RUNS_DEV.md` |
