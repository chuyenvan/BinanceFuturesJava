...
xac nhan). Tien le 912-ngay (2022-01-01..2024-06-30) da co san o `docs/KAGGLE_SIM.md`; file
...
theo dung luat da lap o `docs/KAGGLE_PARITY.md`/`docs/RESULT_S1_DETERMINISM.md` (Oracle=ARM64
...
`docs/KAGGLE_SIM.md` §"Stage lai bundle"). 25 file, ~5.3GB:
...
| `predict_wf_*.bin` x16 + `BINS_SHA256` | `/home/ubuntu/predwf_map_s1a2_x1/` | 888MB — CHI de thoa man guard file-exists cua kernel (bins THAT da nam trong `funding.bin` tu luc build dataset, xem `docs/KAGGLE_SIM.md` §6 — doi thu muc bins KHONG doi ket qua sim) |
...
canh bao cua `docs/KAGGLE_SIM.md` §0.3: **so parity bang md5 `printDone.csv`, KHONG bang
`PROFILE_HASH`.**
