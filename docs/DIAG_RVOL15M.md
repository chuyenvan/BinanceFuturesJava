...
**(5) Sua so sai:** `docs/EVAL_SELECTOR_FEATURES.md` §3 ghi "Nhan `retEnd_4h` **khong phai** nhan train cua
selector (`y = (maxFav_4h >= 6%)`)" — **SAI**; nhan that cua `predwf_G015/model_f*_4h.json` la
`retEnd_4h > 0,015` (`docs/AGENT_RUNBOOK.md:306`). Khong sua file do trong phien nay (chi 1 file duoc commit).

### Pham vi / khong lam

Khong train, khong drop-one, khong sim, khong sua Java/feature, khong doc 2026, **khong push**.
1 file commit: `docs/DIAG_RVOL15M.md`.
