...
Nguồn công thức: `docs/FEAT40_LOOKAHEAD.md` §CÂU 2 (bảng 40/40, có `file:line`) và §CÂU 3 (5 feature OI).
...
**Feature nghi LEAK / phải ghi đè (theo `docs/FEAT40_LOOKAHEAD.md`, không đo lại ở đây):**
