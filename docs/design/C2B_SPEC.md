...
>
> **Baseline hien hanh: `C3` (`docs/experiment/C3_BASELINE.md`, `profiles/c3_min.properties`).**
...
**CUNG MOT hanh vi**, da chung minh **byte-identical** hai lan (`docs/result/C4_RESULT.md`). 7 key khac
...
Do duoc (`docs/result/TICKLOG_RESULT.md`, tren tung **phut-ung-vien**):
...
(NBETS: can 14-43 nam DEV cho 3pp). Va `docs/result/COV_RESULT.md` vua do: tap **gate MO** chi co
...
`docs/ops/BENCH_DEVICE.md`, script `research/kaggle/bench_device/`.
...
⚠️ `docs/result/COV_RESULT.md`: `sd_boot` cua ho chuoi nay **hieu thieu ~21%** => nhan `f = 1.21`.
...
OI bang code hien tai SE dua leak 5 phut vao du lieu**. Patch bat buoc: `docs/ops/OI_FIX_LOG.md` §5.
...
`docs/result/COV_RESULT.md` (2026-09-04) da chung nhan: rank-IC `S1-G015 = +0.0973` CI [+0.0711,+0.1152]
