...
> Huong B (gate 4h -> 72h) **DA duoc pre-register va chay** o vong G5: `docs/prereg/PREREG_G5.md` (`f0b088b`)
> -> `docs/experiment/G5_VALUE_LABELS.md` (`5d1afa7`) — ket qua **XAU HON ro ret** (4/5 rate ngoai CI theo huong xau;
> rang buoc cung FAIL 3/4 nam; equity 39,181 vs 98,523). Xem `docs/result/RESULT_GATE_H72.md`.
