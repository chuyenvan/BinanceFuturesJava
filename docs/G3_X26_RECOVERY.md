...
`docs/G015X26_PROVENANCE.md` §2. Vuot xa cong `>= 0.999`.
...
`docs/PREREG_G015REBUILD.md` + `docs/G015REBUILD_RESULT.md` (2026-09-04) **khong he co gang tai lap
...
Phep so voi x26 that su chi nam o `docs/G015CUT_RESULT.md` §2, va no FAIL:
...
`docs/G015X26_PROVENANCE.md` §1 nang gia thuyet do thanh tuyen bo dut khoat
