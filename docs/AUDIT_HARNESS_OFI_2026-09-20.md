...
`docs/RESULT_S1_FREE_OFI.md` §4, theo dung trinh tu MASTER yeu cau (Giai doan 1 re truoc,
...
- **`docs/RESULT_S1_HPO_BAG_FEATGRP.md`, `docs/PREREG_S1_NOISE_CAL.md`**: cac vong nay
