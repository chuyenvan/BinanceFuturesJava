...
`docs/RESULT_BLACKSWAN_2510.md` phai nam trong danh sach duoi day; phat sinh ngoai danh sach
...
- **KHONG** `claude-run`/Claude Code. **KHONG** chay Java/sim tren Oracle (Oracle chi `mvn -o package`).
  Neu buoc nao BAT BUOC phai sim (stress slip that su) ⇒ **Kaggle** (`docs/KAGGLE_SIM.md`).
