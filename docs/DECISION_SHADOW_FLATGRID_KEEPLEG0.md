...
`docs/RESULT_FLATGRID.md`, `docs/PREREG_FLATGRID.md`.

## ĐÂY LÀ QUYẾT ĐỊNH KHẨU VỊ RỦI RO CÓ Ý THỨC — KHÔNG PHẢI LỖI BỎ SÓT RÀNG BUỘC
Nghiên cứu FLATGRID (`docs/RESULT_FLATGRID.md` mục 6) ra verdict: **KEEPLEG0 KHÔNG đạt luật
...
## Đánh đổi (số liệu từ docs/RESULT_FLATGRID.md mục 6, backtest toàn kỳ)
