...
Pre-reg: `docs/PREREG_X1.md` (commit `91d7b93`), viet va commit TRUOC khi chay bat ky thu gi.
...
=> **No ky thuat**: G015x26 khong tai lap duoc (`docs/G015CUT_RESULT.md`). Chuyen sang G015_v2
