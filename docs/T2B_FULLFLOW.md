...
Tiep noi `docs/T2_FULLFLOW.md`. T2 do duoc phep so selector trong luong day du **o mot diem
...
Pre-reg `docs/PREREG_T2B.md` commit `0058c35` **TRUOC khi chay**. DEV 2022-01-01..2024-06-30.
