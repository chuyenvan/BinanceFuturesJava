...
- `docs/result/RESULT_FLATGRID.md`: KEEPLEG0 **KHONG dat luat thang** (0 rate ngoai CI huong TOT) va
...
- Ly do doi baseline la **DONG BO voi production**: shadow C3 production (paper) da chay KEEPLEG0
  tu **2026-09-19** (`docs/decisions/DECISION_SHADOW_FLATGRID_KEEPLEG0.md`, commit `2fd7357`). Nghien cuu ma
...
- Voi khau vi MOI (`docs/runbooks/RISK_APPETITE.md` §6–§7), UW 147 **PASS** (`<= 250`) — nen objection cu
...
3. **Khong doi gi khac**: khau vi rui ro (`docs/runbooks/RISK_APPETITE.md` §6–§7: `maxDD <= 40%/nam` ·
...
(`docs/result/RESULT_FRAGILITY_N.md`) ⇒ danh **1x**, khong don bay; max concurrent margin ~47–58% equity
