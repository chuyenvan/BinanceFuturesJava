...
Do that 2026-09-05. API: `tools/kaggle_sim.py`. Doc `docs/KAGGLE_RULES.md` truoc (slot, 12h kill,
...
1. **Neo la 60395, KHONG phai 60390.** Kaggle khong co Aerospike ticker nen sim luon chay
   ...
   Xem `docs/KAGGLE_RULES.md` §3e va `docs/GS_BASELINE_NOTE.md`.
...
Hai bien the chay cung luc, doi chieu `docs/E1_EXIT_RESULT.md` (Oracle + aerospike):
...
truoc 04:57:19Z). Tran cua account la **5** (`docs/KAGGLE_RULES.md` §1);
