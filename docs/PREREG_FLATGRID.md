...
Tu `docs/DIAG_BIGDOWN_CONCENTRATION.md`:
...
- **k = 2** (dung 2 gia thuyet: KEEPSCALE, KEEPLEG0).
  ...
  (xem `docs/AUDIT_READJUDICATE_CI_RESCORE.md`).
...
Lam lai dung phuong phap `docs/DIAG_BIGDOWN_CONCENTRATION.md` muc 4 cho ca 2 bien the:
