...
Doc `docs/AUDIT_GATEDYN_GD92.md`. Ket luan cua audit do: **dot 1 (GATEDYN) chap nhan duoc** ve
...
- **k = 2**. `CI_INFLATE = sqrt(2 x ln 2) = 1.177410`. Dung DUNG tu dau ?
  **khong** dung hang so `1.21` sai trong `c3_rates.py` (xem `docs/AUDIT_READJUDICATE_CI_RESCORE.md`).
