...
Ngày: 2026-09-23. Pre-reg: `docs/PREREG_SELECTOR_LEG_CUT.md` (**commit `e566354`**, chốt TRƯỚC khi chạy
...
`wfo_ds_clean` (10 fold, leakFreeFrom 2022-01-01). Bins không đi qua đường Kaggle (`docs/KAGGLE_SIM.md` §6)
...
Vẫn còn 1 file khác có marker y hệt nhưng **ngoài phạm vi vòng này**: `docs/RECON_EVENT_ALPHA.md`.
...
### 4.3 Ràng buộc CỨNG (`docs/RISK_APPETITE.md`)
...
- `docs/PREREG_SELECTOR_LEG_CUT.md` (thiết kế chốt trước), `research/analysis/selcut_run.py`,
...
- Cờ `SELECTOR_LEG_CUT` để lại trong code (default `false` = byte-identical) làm công cụ cho vòng sau;
  **không** bật ở đâu.
- Còn treo (ngoài phạm vi): `docs/RECON_EVENT_ALPHA.md` còn marker merge-conflict y hệt `kaggle_sim.py`.
