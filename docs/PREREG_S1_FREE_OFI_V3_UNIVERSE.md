...
- `docs/RESULT_S1_FREE_OFI.md` + `docs/AUDIT_HARNESS_OFI_2026-09-20.md`: OFI chi phu **15/>600 symbol**
...
## 3. Feature (Y HET `docs/PREREG_S1_FREE_OFI.md` §2 — khong doi mot chu)
