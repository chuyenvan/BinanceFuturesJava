...
Ngày: 2026-09-23. Pre-reg: `docs/PREREG_TRAIL_LADDER.md` (**commit `f8e7333`**, chốt TRƯỚC khi chạy biến
...
## 5. Ràng buộc CỨNG (`docs/RISK_APPETITE.md`) — **PASS cả 3 biến thể**
...
- 🔎 **Đo được lần đầu: 5/5 kernel chạy đồng thời trên bundle 5,3 GB KHÔNG vỡ trần** (`docs/KAGGLE_SIM_48M.md`
...
- `docs/PREREG_TRAIL_LADDER.md` (`f8e7333`), `docs/RESULT_TRAIL_LADDER.md` (file này),
