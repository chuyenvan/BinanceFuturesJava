...
Trang thai: **INPUT chua dung xong** — xem `docs/H1_HOLDOUT_PREP.md`. Pre-reg nay chot
...
5. ⚠️ Bins fold 2026 chua co va **nguon G015x26 khong tai lap duoc** — muc 7. Neu buoc
   ...
   `docs/H1_HOLDOUT_PREP.md` muc 4 truoc khi chay.
...
Lenh day du: `docs/H1_HOLDOUT_PREP.md` muc 7. Log PHAI co dong
...
1. 🔴 **`CLOSES_1H.bin` khong co generator.** Toan bo file tren dia va trong git deu la
   ...
   Chi tiet + hai duong di: `docs/H1_HOLDOUT_PREP.md` muc 3.
2. 🔴 **Bins fold 2026 phai lay P(win) tu dau?** `build_map.py` ap thu hang S1 len
   ...
   (`docs/G015CUT_RESULT.md`, X1 muc 1.3a). Train moi bang `g72_train.py` = ho
