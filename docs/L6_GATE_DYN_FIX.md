...
Nguon: `docs/AUDIT_GATE_DYN_PARITY.md` (`3a36f02`) muc 5.2 huong **A**, sau khi huong **C**
(do bang so) da chay xong va ra ket luan trong `docs/RESULT_FLATGATE.md`.
...
- **Chien luoc gate phang do duoc bao nhieu**: `docs/RESULT_FLATGATE.md` — equity **9,666** vs
