...
Nguồn: `docs/result/NBETS_RESULT.md` (kết luận cuối), `docs/audit/CI_REAUDIT.md`, `docs/data/DATA_EXTENT_SURVEY.md`,
`docs/result/TICKLOG_RESULT.md`, `docs/result/FS_RESULT.md`, `docs/result/G015CUT_RESULT.md`, `docs/result/GS_WAVE1_RESULT.md`,
`docs/result/B4_RESULT.md`.

> **PORT 2026-09-20 (executor TASK C)**: file này trước đó chỉ tồn tại trong project memory của
> MASTER, CHƯA từng được commit vào repo (`git log --all -- docs/notes/power_wall.md` rỗng trước commit
...
`docs/experiment/G015X26_PROVENANCE.md` + trio `docs/design/C2B_PROVENANCE.md`. **KHÔNG được xoá `predwf_G015x26/`** —
...
PREREG `docs/prereg/PREREG_S1PROV.md` @ `020be5b`, kết quả `docs/experiment/S1_PROVENANCE.md` @ `1f7a1bf`):
...
(`docs/analysis/RECON_EVENT_ALPHA.md`, `5b97a07`) đã xong — nguồn listing/delisting (Binance Announcement
...
6. **B2 Bước 8 (breadth theo SUBSET majors/alts, ý Uni; recon `docs/diag/DIAG_BREADTH_SUBSET.md`)**: NO-GO
...
7. **B2 Bước 9 (breadth TOP50 gate LIÊN TỤC = BRCT50; PREREG `docs/prereg/PREREG_BREADTH_CONT_T50.md`
   `6312e06`, RESULT `docs/result/RESULT_BREADTH_CONT_T50.md` `e199557`)**: NULL — hoán vị CUỐI của
