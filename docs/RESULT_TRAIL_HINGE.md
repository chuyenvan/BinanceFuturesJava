...
Pre-reg: `docs/PREREG_TRAIL_HINGE.md` (chốt TRƯỚC khi chạy). Nền: dataset `wfo_ds_x1_2021` (18 fold
...
### 4a. Rào cứng MỚI (`docs/RISK_APPETITE.md`: maxDD≤30%, UW≤200 ngày, quý≥-15%, tập trung 1 coin≤15%) — CỔNG QUYẾT ĐỊNH
