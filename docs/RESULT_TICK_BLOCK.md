...
Ngay: 2026-09-23. Pre-reg: **`docs/PREREG_TICK_BLOCK.md` (commit `b98c9ff`)** — chot TRUOC khi chay.
...
⇒ Nen dung, jar dung; **chi khi cong nay PASS moi doc so 3 bien the** (dung `docs/PREREG_TICK_BLOCK.md` §3.1).
...
## 7. Rang buoc CUNG (`docs/RISK_APPETITE.md`) + tap trung
