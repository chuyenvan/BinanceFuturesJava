...
> SIM_MIN_MOMENTUM_15M=0.008). Kế thừa `docs/ops/EVENT_DATA_SURVEY.md` (c9c5c23) + `docs/TASK_D...design.md`.
...
Thực thi theo `TASK_D_new_alpha_events_design.md` §3 (executor Sonnet). Nguồn nền: `docs/ops/EVENT_DATA_SURVEY.md`
