...
Tien le: `docs/RESULT_EXIT_FIT.md` (commit `eb4c0de`) + harness `research/exitfit/` (commit `8f3194f`)
...
cua so `20210701..20251231`) — cung chan giong `docs/KAGGLE_SIM_48M.md`.
...
- **CI block-72h, 2000 rep, seed `20260905`, anchor `2021-07-01`**, cho hieu `F3 − parity` cua tung
  ...
  `sqrt(2 ln k)`, `docs/AUDIT_CI_INFLATE_STANDARDIZATION.md`; round nay chi **1 ung vien** vs
  ...
  `TSloss%` **giam** = TOT.
- **Rang buoc cung** (`docs/RISK_APPETITE.md`): `maxDD`/nam `<= 30%`; `UW <= 200` ngay; **khong nam
