...
`module`, repo `/home/ubuntu/src/BinanceFuturesJava`. Tiền đề: `docs/RESULT_BREADTH_CONT.md`
(Bước 7, BRC gate liên tục all-coin) = NULL; `docs/RESULT_BREADTH_GATE_SIM.md` (Bước 6, BR
top50 nhị phân) = NULL; `docs/DIAG_BREADTH_SUBSET.md` (Bước 8, subset majors/alts) = NO-GO.
...
u2+u4) BRCT50-0 -> `docs/RESULT_BREADTH_CONT_T50.md` + bảng -> commit (KHÔNG push) -> memory.
