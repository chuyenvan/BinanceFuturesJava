...
> (a) do do nhay BIG_DOWN + (b) don suc vao forward. Doc kem: `docs/DECISION_DCA_PERCOIN_CAP.md`,
> `docs/RESULT_DCA_AGG_PERCOIN.md`, `docs/AUDIT_BIGDOWN_DEEP.md`, `docs/SHADOW_LOG.md`,
> `docs/L1_SHADOW_C3.md`.
...
Nguon so: `docs/RESULT_DCA_AGG_PERCOIN.md` (commit `7aa21a7`), `docs/DECISION_DCA_PERCOIN_CAP.md`.
...
2. **maxDD -11.84 -> -9.64 la so MOT-LAN-QUAN-SAT** (khong co CI). Khong duoc doc thanh "tot hon ve
   thong ke".
3. **Nguong BIG_DOWN `-0.03157` khong ro nguon goc** (co the overfit) — `docs/AUDIT_BIGDOWN_DEEP.md`.
   Duoc do tiep bang bai do nhay `docs/PREREG_BD_THRESHOLD_FRAGILITY.md`.
...
1. Xong bai do nhay BIG_DOWN (`docs/RESULT_BD_THRESHOLD_FRAGILITY.md`) truoc — no quyet dinh nguong
