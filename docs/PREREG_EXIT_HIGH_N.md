...
Vòng trước (`docs/PREREG_GD92_X_EXIT.md` / `docs/RESULT_GD92_X_EXIT.md`, commit `0d1d690`/`4e263c2`)
...
- **T100/GD92 base đã FAIL rào cứng toàn kỳ ngay từ đầu**: T100 maxDD −16.13% / UW 248;
  GD92 maxDD −16.55% / UW 278 (`docs/RESULT_GD92_RECHECK.md` §4).
