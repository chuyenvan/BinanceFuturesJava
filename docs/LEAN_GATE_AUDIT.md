...
Nguon so cho 242 lay tu `docs/runbooks/runbook_live_242_2026-08-19.md` §2/§12.2 va `docs/L1_SHADOW_C3.md`
muc 2 — **khong** SSH 242.
...
|---|---|---|---|---|
| `GateRollingThreshold` (198 dong) + `thres15M` re nhanh | `SIM_GATE_ROLLING_PCT`, `SIM_GATE_ROLLING_DAYS` | **TRO** — khong profile/env nao khai => `isOn()=false`; da bi xoa o `5f40a90` roi **quay lai** o B4 (`a0c7ad6`) | `c1785b9` (pre-reg `a0c7ad6`) | `docs/B4_RESULT.md` (B4 dong), `docs/AUDIT_GATEDYN_GD92.md` |
...
| FLATGATE | `SIM_GATE_DYN_BYPASS` + nhanh `Simulator:964-968` | **TRO** — thi nghiem da dong | `ee00475` | `docs/RESULT_FLATGATE.md` |
...
| `GateRollingThreshold` | **xoa duoc** — quyet dinh nay da duoc `docs/B4_RESULT.md` §6 dat len ban master tu truoc va chua tra loi |
...
Sau do: `docs/CONFIG_FIELD_MAP.md` sinh lai (cach cua `4dd3b04`), `docs/L4_LIVE_BUILDMAP.md` §7
va `docs/AGENT_RUNBOOK.md` muc 0 them cau "gate = mot ham `entryGate`, dung chung sim+live".
...
5. Khong danh gia gate nao **tot hon** — `docs/RESULT_FLATGATE.md` da tra loi cau do
