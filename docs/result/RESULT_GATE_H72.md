...
Pre-reg: `docs/prereg/PREREG_GATE_H72.md` (commit cung dot nay, `module`, nen `2e3bef8`).
...
### 1.1 Proxy (offline, phut) — `g5_proxy.py`, `docs/experiment/G5_VALUE_LABELS.md` §3.1
...
### 1.4 Cong doc lap o tang offline: G1 — `docs/experiment/G1_HORIZON.md` (commit `3b13de6`)
