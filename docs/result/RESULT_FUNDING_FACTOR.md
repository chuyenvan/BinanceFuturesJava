...
Ngày: 2026-09-22. Pre-reg: `docs/prereg/PREREG_FUNDING_FACTOR.md` (**commit `17d600a`**, chốt TRƯỚC khi chạy;
...
`docs/analysis/SURVEY_OLDCODE_SIGNALS.md` §3: **"Funding cross-section — độc lập symbol nhưng ĐÃ ĐO (WFO leakfree
...
- Pre-reg: `docs/prereg/PREREG_FUNDING_FACTOR.md` — commit **`17d600a`**.
