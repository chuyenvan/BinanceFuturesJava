...
Pre-reg: `docs/prereg/PREREG_GIVEBACK_RATIO.md` (commit **`bca8575`**, chot **TRUOC** khi push kernel).
Runner: `research/analysis/gb_run.py` (Kaggle CPU, chi phi 0); scorer: `research/analysis/gb_score.py`;
MTM moc phut: `research/analysis/gb_intraday.py` (tai dung logic da nghiem thu `docs/result/RESULT_INTRADAY_DD.md`,
`RISK_APPETITE` §7.3).
