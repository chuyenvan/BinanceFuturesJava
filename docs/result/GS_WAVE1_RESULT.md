...
**Luat ap dung:** `docs/prereg/PREREG_GS.md` muc 4 (buoc 1-7) + muc 5 + muc 6 + toan bo 5 sua doi
...
- `docs/prereg/PREREG_GS.md`: **khong sua mot ky tu nao** (ke ca them). Moi nhan xet nam trong file nay.
