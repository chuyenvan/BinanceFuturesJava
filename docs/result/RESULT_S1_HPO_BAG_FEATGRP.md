...
Pre-reg: `docs/prereg/PREREG_S1_HPO_BAG_FEATGRP.md` (chốt trước, commit `a04fc10`/`b4cf870`) +
`docs/prereg/PREREG_S1_NOISE_CAL.md` (chốt trước khi xem số noise_1..4, commit `6af7ba5`, đứng trước
...
đại lượng khác thang đo. Sau khi vá chẩn đoán trong-tick (xem `docs/prereg/PREREG_S1_HPO_BAG_FEATGRP.md`
...
## 1. NOISE_CAL — hiệu chuẩn đối chứng nhiễu (pre-reg `docs/prereg/PREREG_S1_NOISE_CAL.md`)
...
`bc9b8bf` (sau `docs/prereg/PREREG_S1_NOISE_CAL.md` commit `6af7ba5`).
