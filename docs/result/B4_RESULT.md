...
Phuong phap **chot TRUOC** o `docs/prereg/PREREG_B4.md`, commit **`a0c7ad6`** (2026-09-03T21:17:50+07:00).
...
CI/bootstrap: `research/analysis/ci_b4.py` (khuon `ci_group_a.py`, `docs/prereg/PREREG_CI.md`).
Tang tung lenh: `research/analysis/paired_test.py` (`docs/prereg/PREREG_PAIRED.md`).
...
**Nhung gi phai SUA trong `docs/audit/AUDIT_APPLIED.md` muc B4** (de nghi, chua sua trong commit nay vi
ngoai pham vi bai):
...
- **Xoa lai** (`git revert c1785b9`, giu lai `docs/prereg/PREREG_B4.md` +
  `docs/result/B4_RESULT.md` + `research/analysis/ci_b4.py`): giu cay sach dung nguyen tac DOT 2. Ban ghi
...
```
git show a0c7ad6:docs/prereg/PREREG_B4.md            # pre-reg, chot truoc
