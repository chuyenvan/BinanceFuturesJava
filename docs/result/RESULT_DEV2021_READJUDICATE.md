...
Pre-reg: `docs/prereg/PREREG_DEV2021_READJUDICATE.md` (commit e57fd3d, chot TRUOC khi chay sim).
...
> thay vi hang so 1.21) — xem `docs/audit/AUDIT_READJUDICATE_CI_RESCORE.md`. Ket qua: T170 co **3** rate chat
