...
Ngày: 2026-09-23. Pre-reg: `docs/prereg/PREREG_LIMIT_ENTRY.md` (**commit `493c02f`, chốt TRƯỚC khi chạy**, không sửa thiết kế sau đó).
...
| `docs/result/RESULT_LIMIT_ENTRY.md` | file này |
| `docs/result/RESULT_FUNDING_SIGN.md` | Phần 1 (funding) |
