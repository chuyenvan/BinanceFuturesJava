...
Pre-reg: `docs/prereg/PREREG_VOL_TARGET.md` (commit `58c5d48`, trước khi chạy COIN/PORTFOLIO).
...
(`docs/runbooks/AGENT_RUNBOOK.md` §3, `X1_GS_T170_2021`). **Byte-identical — cổng bắt buộc PASS**, tin
...
theo ngưỡng MỚI của `docs/runbooks/RISK_APPETITE.md`. PORTFOLIO 2025 UW=164 ngày là dòng DUY NHẤT phân
