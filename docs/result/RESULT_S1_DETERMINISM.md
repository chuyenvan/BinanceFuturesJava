...
> Doi chieu `docs/prereg/PREREG_S1_DETERMINISM.md` (commit `e8963c5`, viet TRUOC khi chay).
...
- **GIU NGUYEN luat "2-baseline rieng cho Kaggle vs Oracle"** cua
  `docs/runbooks/KAGGLE_PARITY.md` muc 4.1-4.2 -- **KHONG bo**. Cam so Kaggle-variant voi
...
- Pre-reg: `docs/prereg/PREREG_S1_DETERMINISM.md` (commit `e8963c5`).
