...
Ngày: 2026-09-22. Pre-reg: `docs/prereg/PREREG_BIGUP_MEDIUPDOWN.md` (commit `5102899`, chốt TRƯỚC khi chạy).
...
Điều này **đo lại và XÁC NHẬN** (không chép) kết luận cũ của `docs/analysis/SURVEY_OLDCODE_SIGNALS.md` §4 về
...
Xem chi tiết + file:line ở `docs/prereg/PREREG_BIGUP_MEDIUPDOWN.md` §1 (nguồn: `/home/ubuntu/trend_review/old_era/`,
...
(số tham chiếu ở `docs/diag/DIAG_BIGDOWN_TRIGGER_MECHANISM.md` §3.3):
...
- Pre-reg `docs/prereg/PREREG_BIGUP_MEDIUPDOWN.md` (commit `5102899`) có **TRƯỚC** mọi phép đo; sau khi
