...
Kết quả cho `docs/prereg/PREREG_REGIME_UPDOWN.md` (commit `ba3d7ba`, chốt TRƯỚC build/sim). Nối tiếp
Bước 2 (`docs/result/RESULT_REGIME_GATE.md`, R=up1.0/down1.7, VERDICT NULL vì vỡ UW-2025). Không đổi
