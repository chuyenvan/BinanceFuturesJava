...
Ngay: 2026-09-23. Pre-reg: `docs/prereg/PREREG_CLOSE_BIGGAP.md` (**commit `7349c39`**, chot TRUOC khi do).
...
- `7349c39` — `docs/prereg/PREREG_CLOSE_BIGGAP.md` (chot TRUOC khi do).
