...
> thêm**, không đảo ngược. Chi tiết đầy đủ + bảng rescore: `docs/audit/AUDIT_CI_INFLATE_STANDARDIZATION.md`
...
> Pre-reg: `docs/prereg/PREREG_DCA_ROUND_CAP.md`. Baseline/parity T170 md5 `efb793e2468ca3a7318da0f0ad23d4fc`.
