...
Ngày: 2026-09-23. Pre-reg: `docs/prereg/PREREG_COST_LIQUIDITY.md` (**commit `cd5e758`**, chốt TRƯỚC khi đo;
...
**Mốc thực tế dùng được (đọc docs, không tự bịa):** `docs/prereg/PREREG_HARNESS_CONTROL.md:38`
(*"taker `0.0005×2 = 0,10%` + slippage 0,5×(high−low)/entry + funding"*);
`docs/prereg/PREREG_HEDGE_OVERLAY_A.md:117` và `docs/design/DESIGN_HEDGED_BOOK.md:112` (*"taker fee 0,05%, slippage 1bp"*).
...
phải fill thật; `docs/analysis/PHASE1_DECISION_SURFACE.md:40` ghi thẳng *"CÒN THIẾU: giá trị fee/slippage BASE chưa
xác nhận"*; `docs/plan/ROADMAP.md:67` để ngỏ *"Calibrate chi phí từ log product thật khi có"*.
...
| File | Nội dung |
|---|---|
| `docs/prereg/PREREG_COST_LIQUIDITY.md` | pre-reg, commit **`cd5e758`** |
...
| `docs/result/RESULT_COST_LIQUIDITY.md` | file này |
