...
dung `docs/prereg/PREREG_S1_FREE_OFI.md` (commit truoc, khong sua sau khi thay so). Ket luan
...
`docs/result/RESULT_S1_DETERMINISM.md` (kernel `chuyendinh/s1-baseline18-det-n1-20260919`),
...
2026-09-19). `docs/result/RESULT_S1_DETERMINISM.md` da xac nhan mot khoang lech kien truc
...
- `docs/prereg/PREREG_S1_FREE_OFI.md` — pre-reg day du (chot truoc so).
...
`docs/audit/AUDIT_HARNESS_OFI_2026-09-20.md`.
