...
> Pre-reg: `docs/prereg/PREREG_CONCENTRATION_SAFETYCAP.md` (commit `9804c62`, viet & commit TRUOC code).
> Code: commit `5e82983`. Branch `module`. Nen so lieu: `docs/diag/DIAG_DCA_CONCURRENCY.md` (`f03a4f1`).
>
