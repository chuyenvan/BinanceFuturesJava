...
Pre-reg: `docs/prereg/PREREG_K12.md` (commit `bc9d066`), viet TRUOC khi chay. Diem bang
`research/analysis/x1_rates.py` + `qret_ladder.py` (2 nguon khop nhau).

## 1. Cong PARITY -- PASS
`X1_C3_FULL_PARITY` (K=8, dataset build lai `wfo_ds_k12`) tai lap DUNG `docs/experiment/X1_EXTEND.md`
