...
> + bảng rescore: `docs/audit/AUDIT_CI_INFLATE_STANDARDIZATION.md` § B.2 ("RESCORE — CA 2 ROUND ĐỔI
...
> Pre-reg: `docs/prereg/PREREG_DCA_AGG_PERCOIN.md`. Baseline/parity T170 md5 `efb793e2468ca3a7318da0f0ad23d4fc`.
