...
Chot truoc: `docs/prereg/PREREG_EXIT_FIT.md` (commit `cb9078f`). Vong nay **thuan Python, khong chay Java/sim**
...
- **Can gi**: jar HEAD + bundle `sim-x1-2021-bundle` + profile `x1_gs_t170` + `SIM_END_DATE=20251231`,
  `TICKER_SOURCE=file` (dung tien le `docs/runbooks/KAGGLE_SIM_48M.md`), va **1 profile moi** `x1_gs_t170_close`:
...
## 6. Commit (khong push)
- `cb9078f` — prereg `docs/prereg/PREREG_EXIT_FIT.md` (chot truoc khi do).
