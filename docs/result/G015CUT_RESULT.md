...
> 🟠 **DINH CHINH 2026-09-06 (`docs/experiment/G3_X26_RECOVERY.md`):** gia thuyet §2.2 ("ban export Tool1
...
Tien dang ky: `docs/prereg/PREREG_G015CUT.md`, commit **9db99ef342bbd4ae466c2f355221a94182e12057**
...
Cong thuc da chot o `docs/data/DATA_EXTENT_SURVEY.md` §3 (`MDE80(T) = z * sd_dev * sqrt(T_dev/T)`,
...
| thu | duong dan |
|---|---|
| tien dang ky | `docs/prereg/PREREG_G015CUT.md` @ 9db99ef |
