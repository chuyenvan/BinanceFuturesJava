...
Ngay: 2026-09-23. Pre-reg: `docs/prereg/PREREG_CAPACITY_DIAG.md` (**commit `aedf535`**, chot TRUOC khi do).
...
| `cand.bin.gz` (`/home/ubuntu/tick/R5_TL`, `R6_TL`) parse lai doc lap (32B/row) | profile **C2b** (env-mode), DEV 2022-01..2024-06 | **do lai tu file goc**, khop byte voi `docs/result/TICKLOG_RESULT.md` §5 |
...
⇒ khop tung so voi `docs/result/TICKLOG_RESULT.md` §5 (bang cu), va khop **cheo** voi T170: tong cua so ung
...
- `aedf535` — **`docs/prereg/PREREG_CAPACITY_DIAG.md`** (chot TRUOC khi do: nguong H1 1%/20%/20%, thuoc MOI
