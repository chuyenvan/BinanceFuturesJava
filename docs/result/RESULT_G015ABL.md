...
Pre-reg: `docs/prereg/PREREG_G015ABL.md`. Diem bang `research/analysis/x1_rates.py X1_C3_G015ABL0
...
`docs/experiment/G4_RECIPE_C4.md` da do: retrain lai net015 qua `g015_net_train.py` (cung trainer dung
