...
`/home/ubuntu/src/BinanceFuturesJava` nhánh `module`. Thiết kế khoá trước ở `docs/prereg/PREREG_BREADTH_GATE_SIM.md`
...
— tức gate breadth (not_up 72.3% thời gian trong cửa sổ sim, xem `docs/prereg/PREREG_BREADTH_GATE_SIM.md`) đóng
