...
Ngay 2026-09-23. Thuc thi `docs/prereg/PREREG_LIVE_VS_SIM.md` (commit `edcc551`) — **chot TRUOC**,
...
2. **(b) Config KHONG dong nhat:** lo 06/09 (14 lenh) chay **gate PHANG 0,008** (truoc fix 18/09;
   `docs/analysis/SHADOW_EVAL_20260911.md`, `docs/experiment/L6_GATE_DYN_FIX.md`) — **khong phai T170**. Lo 18-19/09
