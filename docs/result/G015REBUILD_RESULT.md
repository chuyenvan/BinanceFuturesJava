...
> 🟠 **DINH CHINH 2026-09-06 (`docs/experiment/G3_X26_RECOVERY.md`):** `predwf_G015_v2` **khong phai** ban
...
PREREG: `docs/prereg/PREREG_G015REBUILD.md` @ **0449f21** (commit TRUOC khi train). Ngay: 2026-09-04.
...
`/home/ubuntu/predwf_G015_v2/` (10 file, sha256 o `docs/experiment/G015_PROVENANCE.md` §1 va
...
Bang chi tiet: `docs/experiment/G015_PROVENANCE.md` §2.
...
| provenance | `docs/experiment/G015_PROVENANCE.md`, `research/analysis/g015rebuild_inputs_sha.json` |
