...
Pre-reg `docs/prereg/PREREG_FLATGATE.md` (commit `ee00475`, TRUOC khi chay). Nen
`X1_C3_FULL_PARITY_R`. Audit nguon: `docs/audit/AUDIT_GATE_DYN_PARITY.md` (`3a36f02`) muc 5.2 huong C.
...
(sua live cho khop sim) — patch da soan o `docs/experiment/L6_GATE_DYN_FIX.md`, **chua deploy**.
...
1. **Huong A cua audit duoc du lieu ung ho**: sua LIVE cho khop SIM. Patch da soan:
   `docs/experiment/L6_GATE_DYN_FIX.md` + goi `deploy_242_l6`. **CHO USER DUYET, chua deploy.**
...
3. `docs/analysis/SHADOW_EVAL_20260911.md` va `docs/ops/DEV_COLLAPSE_CHECK_20260911.md` da duoc dan khung
