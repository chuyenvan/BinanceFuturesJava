...
Pre-reg: `docs/prereg/PREREG_GATESCALE_KEEPLEG0.md` (commit `a75c00a`, viet/chot TRUOC khi push kernel).
...
kernel** (`docs/runbooks/KAGGLE_SIM.md`), **khong** chay Java/sim tren Oracle. Chi phi Kaggle **0**.
Ra soat lai luat: `docs/runbooks/RISK_APPETITE.md` §6–§7 (maxDD<=40% · UW<=250 · qmin>=-20% · khong nam am ·
...
- Vong quet gate-scale tren nen 1,1,3,8 (`docs/prereg/PREREG_GATESCALE_SWEEP.md`) **CHUA DOI CHIEU DUOC**:
