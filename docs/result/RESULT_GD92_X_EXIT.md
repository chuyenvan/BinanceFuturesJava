...
Pre-reg: `docs/prereg/PREREG_GD92_X_EXIT.md` (commit **`0d1d690`**, viet TRUOC khi chay).
...
Tất cả sim chạy trên **Kaggle CPU kernel** (`docs/runbooks/KAGGLE_SIM.md`); **KHÔNG chạy Java/sim trên Oracle**.
...
## 3. Rào cứng `docs/runbooks/RISK_APPETITE.md` — PASS cả **theo năm** LẪN **toàn kỳ**
