...
Ngày: 2026-09-23. Pre-reg: `docs/prereg/PREREG_LIMIT_ENTRY.md` (**commit `493c02f`, TRƯỚC khi đo**).
...
|---|---|---|---|---|
| 1 | `docs/result/RESULT_COST_LIQUIDITY.md:197` | `funding_pct = −funding/margin` mean **+0,1209%** | **PnL (`dương` = ĐƯỢC thu)** | **Được THU** 0,1209%/lệnh (sim) |
...
| 5 | `docs/result/RESULT_FUNDING_TOPK_ROTATE.md:13-14,176` | `f_cum = −0,256%/chu kỳ` (K=5) | **Chi phí (`âm` = THU)** | **Thu** +0,77%/ngày |
| 6 | `docs/result/RESULT_FUNDING_TOPK_K13.md:298-299` | `f_cum = −0,5755% (K=1)` | như trên | Thu (+1,73%/ngày ở K=1) |
| 7 | `docs/result/RESULT_FUNDING_FACTOR.md:87,108-110,194` | D1 −0,0294%/24h; **D10 +0,0742%/24h** | **Chi phí (`+` = TRẢ)** | D1 (funding thấp nhất) **thu**; D10 **trả** |
| 8 | `docs/result/RESULT_COST_REAL_AUDIT.md` §0(3), §2.3 | THU 31,8% / TRẢ 68,2%; **mean −0,2518%/lệnh** | **Chi phí (`âm` = THU)** | **THU ròng** (luận điểm của vòng 2026-09-23) |
| 9 | `docs/design/DESIGN_HEDGED_BOOK.md:46-57` | — | phát biểu quy ước | "Funding BTC perp **dương phần lớn thời gian** ⇒ **short BTC NHẬN**"; cảnh báo **dấu cho `SELL` trong code là SAI** (mô hình bảo thủ) |
| 10 | `docs/prereg/PREREG_LEVEL_SENSITIVITY.md:51`, `docs/prereg/PREREG_REVERSAL_BOUNCE.md:81`, `docs/prereg/PREREG_BIGUP_MEDIUPDOWN.md:189` | — | phát biểu quy ước | "long **trả** funding dương" |
| 11 | `docs/data/DATA_EXTENT_SURVEY.md:192-213` | BTCUSDT funding p50 **+1,00 bp**; p99 +6,5..+15,9 bp (2020-21) | rate thô | funding **dương phần lớn thời gian**; "funding dương kéo dài cực mạnh không tồn tại trong DEV" |
| 12 | `docs/diag/DIAG_ALT_IDIOSYNCRATIC_RISK.md:17` | cột `funding` = funding FEE **USDT** (đã nhân) | Chi phí (`+` = trả) | kế toán USDT, không nêu dấu tổng |
...
| File | Nội dung |
|---|---|
| `docs/prereg/PREREG_LIMIT_ENTRY.md` | chốt trước (commit `493c02f`) |
| `docs/result/RESULT_FUNDING_SIGN.md` | file này — truy vết + đo 2 tầng + chốt quy ước + số đúng |
