...
> 🔴 **DINH CHINH 2026-09-04 (sau `docs/result/LABEL_ROI2_RESULT.md`): muc 2.1 duoi day PHAI RUT.**
...
**He qua nghiem trong:** `docs/design/C2B_SPEC.md §5.1` da xac dinh **`STOP_LOSS_DONE` = time-stop 7 ngay**
