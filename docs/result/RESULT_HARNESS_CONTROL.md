...
Ngày: 2026-09-22. Pre-reg: `docs/prereg/PREREG_HARNESS_CONTROL.md` (commit `9611823`, chốt TRƯỚC khi chạy;
...
- Pre-reg `docs/prereg/PREREG_HARNESS_CONTROL.md` (commit **9611823**) có **TRƯỚC** mọi phép đo.
...
pre-reg docs/prereg/PREREG_HARNESS_CONTROL.md (commit 9611823); harness nguyen ban: HOLD 1440,
...
docs/result/RESULT_BIGUP_MEDIUPDOWN.md §3.2 (can tren, 2024 chi tinh 6 thang); reversal-bounce N=1 179 302
va net DEV -0.080% lay tu docs/result/RESULT_REVERSAL_BOUNCE.md (CI rieng cua no: half x1.21=0.43%).
```
