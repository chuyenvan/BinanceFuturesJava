...
Ngày: 2026-09-22. Pre-reg: `docs/prereg/PREREG_FUNDING_TOPK_K13.md` (**commit `6d1a8fd`**, chốt TRƯỚC khi chạy).
Vòng gốc: `docs/prereg/PREREG_FUNDING_TOPK_ROTATE.md` (`55b8280`) + `docs/result/RESULT_FUNDING_TOPK_ROTATE.md` (`fdf61d7`).
...
Tiền lệ xa: `docs/analysis/SURVEY_OLDCODE_SIGNALS.md` — rule `FUNDING_FEE_BUY` → ML `funding_selector` → **FAIL
...
- Pre-reg: `docs/prereg/PREREG_FUNDING_TOPK_K13.md` — commit **`6d1a8fd`** (commit **TRƯỚC** khi chạy).
