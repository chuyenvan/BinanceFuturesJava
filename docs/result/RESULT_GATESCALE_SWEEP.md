...
Pre-reg: `docs/prereg/PREREG_GATESCALE_SWEEP.md` — commit `bc6082b`, amend `31f4baa` (duong override)
va `4835854` (them chuan S3), **ca ba deu TRUOC khi co bat ky ket qua sim nao**. Code+tag:
commit `a450046`. Chay **2026-09-24**, branch `module`. Sim **tren Kaggle** (`docs/runbooks/KAGGLE_SIM.md`),
...
1. **NEN CU.** Vong nay do tren **nen `x1_c3_full`/`x1_gs_t170` (DCA_GRID_WEIGHTS `1,1,3,8`,
   ...
   (DCA `1,1,1,1` + scale 6.0, parity `99e42b75`, 1085 leg — xem `docs/decisions/DECISION_BASELINE_KEEPLEG0.md`).
