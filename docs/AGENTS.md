...
| 017 feature gate B giá/xu-hướng + funding-breadth | CCD #1 (giao) | 🟡 TODO | 2026-06-14 | 226 (đọc)→CSV | B1-B5 + B7 code mới; nguồn kline_15m/4h(009)+funding_data(226); align gate_return; validate riêng a-e; **System.exit cuối main (#6)**; LÀM NGAY song song 015 (khác feature) |
