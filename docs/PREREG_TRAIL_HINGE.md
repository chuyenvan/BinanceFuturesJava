...
(`docs/C3_BASELINE.md` B1): truoc do `symbolPred` khong duoc chep sang object CUM, nen
...
THAT SU hoat dong tu do den nay, nhung CHUA CO RESULT nao do rieng no. `docs/C3_BASELINE.md` §9
...
(b) **REPRODUCTION**: re-run T170 (profile `x1_gs_t170.properties`, dataset `wfo_ds_x1_2021`, jar
    ...
    `SIM_END_DATE=20251231` theo `docs/RESULT_DEV2021_READJUDICATE.md` §7) -> devrun
...
gap12, weak17; baseline T170 khong tinh) => he so **1.482304** (`docs/AUDIT_CI_INFLATE_STANDARDIZATION.md`).
...
CUNG HUONG TOT** VA **PASS rao cung theo nam theo khau vi MOI** (`docs/RISK_APPETITE.md`:
