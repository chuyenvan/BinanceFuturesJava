...
Pre-reg: docs/PREREG_LIVE_EQ_SIM.md. Code SHA base HEAD aa46fb1 (branch module). Chi Oracle.
...
- Tang-1 net015 la RAW (khong quantile-map). Full parity map-level tang-1 (LiveBuildMap) can S1 rank
  (OI history 2 thang tren 242) = tier-2, VAN VUONG blocker OI nhu docs/AUDIT_SELECTOR_MODEL_PARITY.md.
