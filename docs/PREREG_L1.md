...
dong bang, khong tai lap, khong co ban 2026 — `docs/H1_HOLDOUT_PREP.md` muc 5). Neu dung
...
- Nen: `X1_C3` (48 thang, `docs/X1_EXTEND.md`): 2,058 lenh, win 85.33%, TSloss 14.87%,
...
3. `L1_PNP_WEAK` doi 83.8% so lenh => du doan doi HINH DANG phan bo winner theo dung
   co hoc muc 4 `docs/C3_BASELINE.md` (than LEN ~1pp, duoi phai TUT ~1pp), nhung
