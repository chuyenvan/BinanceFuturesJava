...
Chot truoc: `docs/PREREG_PEAK_CLOSE.md` (commit `1fcabe4`). Code: commit `dca07ce`.
Tien le: `docs/RESULT_EXIT_FIT.md` (harness offline, `eb4c0de`) — F3 la ung vien DUY NHAT con lai.
...
**dung 3 diem doi, khong gi khac** (chi tiet o `docs/PREREG_PEAK_CLOSE.md` §1):
...
- `1fcabe4` — prereg `docs/PREREG_PEAK_CLOSE.md`.
