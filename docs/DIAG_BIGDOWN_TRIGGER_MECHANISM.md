...
| Script | `/tmp/bd_diag.py`, `/tmp/bd_diag2.py` tren Oracle (read-only, **khong commit vao repo** — cung quy uoc `docs/DIAG_DCA_CONCURRENCY.md` muc 7.6) |

**Ve "cross-sectional dispersion cua alt":** `docs/DIAG_UW_WINDOW_202503_202510.md` **KHONG co logic
...
`docs/AUDIT_GATE_DYN_PARITY.md` da tung ghi nhan: hai ban sao cua cung mot cong troi khoi nhau).
...
va ca 3 gate T100/T130/T170 deu cho **cung 248 leg BIG_DOWN** (`docs/DIAG_DCA_CONCURRENCY.md` muc 6),
