...
Tu `docs/DESIGN_ROLLING_BIGDOWN.md` (06dadd3) + duyet cua user 2026-09-16.

## 0. Vi sao huong nay
- Truc SIZING (`docs/RESULT_BD_SIZE_ADAPT.md`, commit `a34083a`) da NULL: size theo severity chi
...
5. Ghi `docs/RESULT_SEL_BIGDOWN.md`, commit (KHONG push).
