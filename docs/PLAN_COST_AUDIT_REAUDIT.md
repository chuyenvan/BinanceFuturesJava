...
| File | Nội dung |
|---|---|
| `docs/PLAN_COST_AUDIT_REAUDIT.md` | file này (kế hoạch, viết trước) |
| `docs/RESULT_COST_REAL_AUDIT.md` | Phase A + Phase B (inventory + phân bố fee/slip/funding-limit + gross→net) |
