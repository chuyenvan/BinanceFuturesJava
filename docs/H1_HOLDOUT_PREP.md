...
Pre-reg: `docs/PREREG_H1.md`. Nhiem vu cua dot nay la **chuan bi dau vao roi DUNG**.
...
`docs/PREREG_FS.md` muc 0 va `docs/FS_RESULT.md` muc 0.1 do duoc
...
- `predwf_G015x26` **KHONG tai lap duoc** — mat training export (`docs/G015CUT_RESULT.md`;
...
| `docs/PREREG_H1.md` | pre-reg 2 arm, cua so, tieu chi, du doan ghi truoc |
| `docs/H1_HOLDOUT_PREP.md` | file nay |
