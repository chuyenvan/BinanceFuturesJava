...
Ngày: 2026-09-22. Pre-reg: `docs/PREREG_FUNDING_TOPK_ROTATE.md` (**commit `55b8280`**, chốt TRƯỚC khi
...
`docs/SURVEY_OLDCODE_SIGNALS.md`: rule `FUNDING_FEE_BUY` → ML `funding_selector` → **FAIL (WFE med 0,098)**.
