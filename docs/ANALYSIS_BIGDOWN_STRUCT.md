...
Ket qua tinh theo dung cong thuc da khoa trong `docs/PREREG_BIGDOWN_STRUCT.md` (commit `22c0815`).
...
CHINH XAC voi `docs/DIAG_BIGDOWN_CONCENTRATION.md` cua vong truoc => du lieu nap dung.
