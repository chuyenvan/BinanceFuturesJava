...
kernel** (`docs/KAGGLE_SIM.md`, `docs/KAGGLE_SIM_48M.md`) — **KHONG** chay Java/sim tren Oracle
...
- `x1_gs_t170` va `x1_c3_full` **khac nhau DUNG 1 dong** (`SIM_GATE_DYN_SCALE=1.70`) — kiem bang
  `diff` (docs/PREREG_GATESCALE.md §1; da kiem lai trong vong nay, xem commit runner).
...
- Kaggle sim T170 tren cua so 2021-07..2025-12 la **byte-identical** voi Oracle
  (`docs/KAGGLE_SIM_48M.md` §0/§4) => Kaggle la Oracle-tuong-duong cho profile/cua so nay.
- **Rao cung dang chan khong phai maxDD.** `docs/RISK_APPETITE.md` §6 (2026-09-24, chot cua user)
...
|---|---|---|---|
| 1.70 | `t170-x1-2021` | **TAI SU DUNG** | da co tren bundle nay, md5 `efb793e2` khop Oracle (`docs/KAGGLE_SIM_48M.md` §0), `n=1089/equity=111070` khop |
...
5. `docs/RESULT_GATESCALE_SWEEP.md` + ket luan (a)(b)(c). Commit SAU (khong push).
6. Don temp.
