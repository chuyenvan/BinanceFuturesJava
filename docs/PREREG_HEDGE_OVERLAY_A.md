...
Tien de: `docs/DESIGN_HEDGED_BOOK.md` (commit `8a081ae`) da RECON xong TASK 2 va DUNG o
...
`docs/power_wall.md` xac dinh duong power duy nhat con song la **tang so cuoc doc lap**.
`docs/NBETS_RESULT.md` muc 4.2 do ICC (mot chieu, ANOVA, cohort = ngay vao lenh) = **+0.2468**
