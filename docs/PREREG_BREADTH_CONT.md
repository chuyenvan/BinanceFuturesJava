...
`/home/ubuntu/src/BinanceFuturesJava`. Tiền đề: `docs/RESULT_BREADTH_GATE_SIM.md` (Bước 6, BR
...
## 6. NỀN SO SÁNH
T170 byte-identical Oracle==Kaggle (md5 `efb793e2`, đã xác nhận `docs/KAGGLE_SIM_48M.md`). T100/
...
BRC0 → metric u1–u5 → `docs/RESULT_BREADTH_CONT.md` + bảng → commit (KHÔNG push) → memory.
