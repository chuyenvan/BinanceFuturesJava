...
### 2C. `docs/prereg/PREREG_GATEFEAT.md` (đánh giá 33 feature của gate p15)
...
- `docs/experiment/L5_S1_WARMUP_242.md` — chứa cụm số **"coin >= 336"**, **"336"** nhiều lần. ĐỐI CHIẾU TRỰC TIẾP: đây là ngưỡng warm-up của `S1RankerLive` = 336 mốc giờ = 14 ngày × 24h dữ liệu close 1h cần có để coin "sẵn sàng" cho live-ranking — không thấy liên hệ với MA hay holdout kiểm định chiến lược trong file này.
- `docs/ops/OI_FIX_LOG.md` — chứa "320 cap/symbol", "SYMBOL (n=4,320..." — là số cặp đo lường OI-fix, không liên quan MA/holdout.
- `docs/prereg/PREREG_C3.md` — chứa "348) mang symbol..." — về logic leg/symbolPred của C3, không liên quan.
