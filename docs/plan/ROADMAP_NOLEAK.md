...
| ID | Việc | Ai | Trạng thái |
|----|------|----|-----------|
| 1.1 | Đọc 3 file gốc → bảng quyết định cụ thể `docs/analysis/PHASE1_DECISION_SURFACE.md` (giá trị hiện tại + 7 chỗ nhiễm/chưa-chốt) | 🧭 | ✅ |
| 1.2 | QUYẾT từng dòng (đã xong: label · 14 gene range · fitness v2 · budget mới · trailing per-coin) | 👤 | ✅ |
| 1.3 | `docs/analysis/PHASE1_RECIPE_FROZEN_v1.md` → sha256 738772ff… → KÝ chuyennd 2026-08-24 | 👤 | ✅ |
