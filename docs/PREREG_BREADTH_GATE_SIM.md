...
Tiền đề: `docs/DIAG_BREADTH_REGIME.md` (commit `4f4801c`/`dee1672`) — market-breadth (định nghĩa A:
...
`docs/RESULT_BREADTH_GATE_SIM.md` verdict + đối chiếu §4. 9. Commit code+docs branch `module`,
