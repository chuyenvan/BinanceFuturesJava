...
Kết quả cho `docs/prereg/PREREG_UW2025_DIAG.md` (commit `84ba4ac`, chốt TRƯỚC khi tính số). Script:
...
- `docs/prereg/PREREG_UW2025_DIAG.md` (commit `84ba4ac`, khoá định nghĩa/công thức/ngưỡng TRƯỚC khi
  tính số).
