...
bao nhieu?"* — khac cau hoi cua `docs/diag/DIAG_BIGDOWN_CONCENTRATION.md` (do PER-COIN: 1 coin nhoi
...
3. Bac grid suy tu thu tu leg trong `printDone.csv`, khong doc truc tiep bien `legCount` trong sim.
   ...
   muc 4 cua `docs/diag/DIAG_BIGDOWN_CONCENTRATION.md` (T170 16/4/0, T130 22/8/1, T100 42/11/1 doc theo
