...
Theo `docs/prereg/PREREG_BREADTH_REGIME_DIAG.md` (commit `3536a2a`, khoa metric/cong TRUOC khi tinh so).
...
`docs/prereg/PREREG_BREADTH_REGIME_DIAG.md` (`3536a2a`) + `research/analysis/breadth_regime.py` (moi,
...
Định nghĩa khoá TRƯỚC khi tính tại `docs/prereg/PREREG_BREADTH_REGIME_DIAG.md` §6. Chạy lại
...
`summary_a_b_c`) + `docs/prereg/PREREG_BREADTH_REGIME_DIAG.md` §6 (khoá định nghĩa B/C trước khi tính,
