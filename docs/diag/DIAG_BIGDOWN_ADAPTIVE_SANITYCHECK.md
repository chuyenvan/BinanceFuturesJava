...
> **khong tinh PnL**. Noi tiep `docs/diag/DIAG_BIGDOWN_TRIGGER_MECHANISM.md` (commit `796ae01`).
>
...
| Tai lieu nen | `docs/diag/DIAG_BIGDOWN_TRIGGER_MECHANISM.md` (`796ae01`), `docs/diag/DIAG_DCA_CONCURRENCY.md` (`f03a4f1`) |
