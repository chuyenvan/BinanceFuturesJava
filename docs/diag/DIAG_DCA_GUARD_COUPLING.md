...
Doc kem: `docs/diag/DIAG_BIGDOWN_TRIGGER_MECHANISM.md`, `docs/diag/DIAG_BIGDOWN_CONCENTRATION.md`,
`docs/diag/DIAG_DCA_CONCURRENCY.md`, `docs/prereg/PREREG_CONCENTRATION_SAFETYCAP.md`,
`docs/design/DESIGN_ROLLING_BIGDOWN.md`.
