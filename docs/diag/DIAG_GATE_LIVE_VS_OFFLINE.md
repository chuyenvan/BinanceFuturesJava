...
- **Tiền đề của task đã cập nhật**: `docs/diag/DIAG_FORWARD_PIPELINE.md` (commit `b35b231`) giả thuyết "cổng đóng
...
2. **B5 (p15 live vs offline)**: **không so được cùng mốc thời gian** — artifact offline **kết thúc
   2026-06-30**, live bắt đầu 2026-09-20 (không có cửa sổ giao nhau, đúng như `docs/experiment/L1_SHADOW_C3.md` §(d)
...
theo mốc**. Đây chính là blocker đã ghi ở `docs/experiment/L1_SHADOW_C3.md` §(d) ("chưa chứng minh được đồng nhất")
...
"symbolPred live bị đẩy lên ~2 lần" như một giả thuyết có thể có (ghi chú `docs/experiment/G4_RECIPE_C4.md` §6.2
