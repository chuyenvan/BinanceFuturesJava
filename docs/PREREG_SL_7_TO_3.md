...
Sim chay **tren Kaggle CPU kernel** (`docs/KAGGLE_SIM.md`). **KHONG** Java/sim tren Oracle
...
`docs/RESULT_GATESCALE_KEEPLEG0.md` §1).
...
2. **`maxDD` + `UW` tren MTM MOC PHUT** (BAT BUOC, `RISK_APPETITE.md` §7.3): tai tao theo dung
   cach `docs/RESULT_INTRADAY_DD.md` (`equity_mtm(m) = 35,000 + realized(m) + unP(m)`, mark
...
- Ket qua: `docs/RESULT_SL_7_TO_3.md`; runner `research/analysis/sl3_run.py`;
