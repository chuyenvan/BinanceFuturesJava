...
liệu descriptive có sẵn (không chạy sim mới, dùng lại số đã đo): `docs/DIAG_BIGDOWN_CONCENTRATION.md`,
`docs/DIAG_DCA_CONCURRENCY.md`, `docs/RESULT_CONCENTRATION_SAFETYCAP.md` — ba tài liệu này đã đo
