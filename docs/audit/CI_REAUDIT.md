...
Phuong phap: **`docs/prereg/PREREG_CI.md`, commit `2493eca`** — chot **TRUOC** khi tinh CI nao.
...
Nguon cua van de: `docs/analysis/LEAK_L1_REPORT.md` — grid mau 15m + nhan cua so 72h => n hieu dung tren
...
- **Khong sua `docs/prereg/PREREG_GS.md`**, khong cham `/home/ubuntu/gs/`, `research/kaggle/gsearch/*`.
