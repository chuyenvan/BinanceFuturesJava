...
`41d5d76` tren branch `module`, doc `docs/result/RESULT_GATEDYN.md` + `docs/result/RESULT_GATEDYN2.md`.
Pham vi: doc lai toan bo bang chung, chay LAI GD92 tu dau tren dataset build lai, va cham lai
bang chinh khung pre-reg cua du an (`docs/prereg/PREREG_CI.md`, `docs/prereg/PREREG_X1.md`, `docs/prereg/PREREG_B4.md`).
...
`docs/result/B4_RESULT.md` dong 179-180 cam ten: *"KHONG mo them bien the tren cung khong gian (noi cua
...
- `X1_C3_FULL_PARITY_R` md5 `printDone.csv` = `2478e90d4e61…` (ca header) va
  ...
  dung con so canonical trong `docs/result/RESULT_5MGRID.md` / `K12_RESULT.md`. **Baseline hop le, khong
  co troi nen.**
...
- `UW <= 120` **khong** phai tieu chi bia them sau khi thay so: hang `HARD_DD, HARD_UW, HARD_Q =
  ...
  (2026-09-05 20:53), tuc **truoc GATEDYN 4 ngay**, va `docs/prereg/PREREG_X1.md` dong 176 ghi
