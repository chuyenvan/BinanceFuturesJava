...
>
> Nen: `docs/audit/CI_REAUDIT.md`, `docs/prereg/PREREG_CI.md`, `docs/audit/AUDIT_READJUDICATE_CI_RESCORE.md`,
...
`docs/prereg/PREREG_2X_HALFSIZE.md` muc 5 — **KHONG xoa, KHONG viet lai**. Da chen mot khoi
