...
Ngày: 2026-09-23. Pre-reg: `docs/PREREG_SHORT_CARRY.md` (**commit `edd1e70`, chốt TRƯỚC khi đo**;
...
| File | Nội dung |
|---|---|
| `docs/PREREG_SHORT_CARRY.md` | chốt trước (commit `edd1e70`) |
| `docs/RESULT_SHORT_CARRY.md` | file này |
