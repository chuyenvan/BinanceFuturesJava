...
Sinh luc: 2026-09-04 (Oracle, CPU). Tuan theo `docs/prereg/PREREG_S1PROV.md` (commit 020be5b).
...
OI **KHONG rebuild** (code hien tai gay leak — `docs/ops/OI_FIX_LOG.md`); sha dung lai tu `G015_PROVENANCE`.
...
**Va co bang chung TIEN (forward), manh hon van ban da mat:** `docs/result/FS_RESULT.md` (pre-reg
`docs/prereg/PREREG_FS.md`) sang **16 ung vien feature moi** (5 nhom gia/volume/funding chua tung co trong
