...
Boi canh: `docs/experiment/G3_X26_RECOVERY.md` (bins tai sinh bang PREDICT tu 18 model da luu).
...
- Theo luat da chot `docs/ops/BENCH_DEVICE.md` muc 7.4 — *"hieu ung phai vuot CI multi-seed do
...
2. **Trainer nay KHONG tai lap `predwf_G015_v2`.** `G015_v2` la nhan `maxFav_4h >= 0.06`
   ...
   `docs/result/G015REBUILD_RESULT.md` truoc.
