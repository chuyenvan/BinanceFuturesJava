...
Ngay 2026-09-06. Tiep noi `docs/experiment/L1_SHADOW_C3.md`. **242 CHI DOC** (chi doc 2 file model + config,
...
🟢 **Dinh chinh `docs/plan/H1_HOLDOUT_PREP.md` muc 3**: gia thuyet "ticker 1m gop len" **KHONG bi bac** —
...
so 4 cua `docs/experiment/L1_SHADOW_C3.md` muc 0.
