...
Pre-reg `docs/prereg/PREREG_T2.md`, commit TRUOC khi chay. DEV 2022-01-01..2024-06-30
...
selector cu trong `profiles/c3.properties` (`docs/result/G015REBUILD_RESULT.md`).
