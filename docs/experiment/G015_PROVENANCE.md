...
Sinh luc: 2026-09-04 (Oracle, CPU). Tuan theo `docs/prereg/PREREG_G015REBUILD.md` (commit 0449f21).
Day la baseline G015 chinh thuc MOI, thay cho bins deploy cu `claudedata/predwf_G015x26/`
(**khong tai lap duoc** — xem `docs/result/G015CUT_RESULT.md`). Bins cu KHONG bi xoa/ghi de.
...
`docs/result/G015REBUILD_RESULT.md` §6).
