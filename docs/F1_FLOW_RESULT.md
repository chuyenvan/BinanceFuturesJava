...
Pre-reg: `docs/PREREG_F1_FLOW.md` (commit `576e6c2`, viết TRƯỚC run đầu tiên).
...
chạy hơn** — rơi đúng vào nhóm time-stop 168h đã mô tả ở `docs/E0_EXIT_CF.md`.
...
câu hỏi "selector variant" đã chốt VOID ở `docs/SELECTOR_LADDER_Q.md`. Không mở lại.)
