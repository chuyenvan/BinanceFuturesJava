...
Ly do dong cu (`docs/audit/AUDIT_APPLIED.md` muc B4): "RG95/RG97/RG95w180 deu thap hon C2b 60390
(56683 / 52045 / 59120) => THUA tren nen C2b; EV am tren nen C2b => khong nen".

Do lai bang block-bootstrap **ghep cap** (`docs/audit/CI_REAUDIT.md` NHOM A #6c/#6d/#6e, phuong phap
chot truoc o `docs/prereg/PREREG_CI.md`): **ca 3 hieu nam TRONG CI**:
...
6. Viet `docs/result/B4_RESULT.md` theo dung section 3 / 4 / 5 / 7. Commit **sau**.

## 10. NHUNG GI PRE-REG NAY KHONG LAM

- Khong doi diem uoc luong nao cua C2b (b:60390 / CAGR 24.43 / maxDD -13.12).
- Khong sua `docs/prereg/PREREG_CI.md`, `docs/prereg/PREREG_GS.md`, `docs/audit/CI_REAUDIT.md`.
