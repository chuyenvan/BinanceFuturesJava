...
Trạng thái: **ĐANG CHỜ ĐO** (khi xong ⇒ `docs/result/RESULT_RANGE4H_TOPK.md`).
...
3. **(c) Dẫn chiếu vòng trước**: `RESULT_FUNDING_TOPK_ROTATE.md` (commit `fdf61d7`) — top-K funding
   ...
   Tiền lệ xa: `docs/analysis/SURVEY_OLDCODE_SIGNALS.md` (`FUNDING_FEE_BUY` → FAIL WFE 0,098).
...
- Kết quả: `docs/result/RESULT_RANGE4H_TOPK.md`. Commit pre-reg + script + kết quả. **KHÔNG push.**
