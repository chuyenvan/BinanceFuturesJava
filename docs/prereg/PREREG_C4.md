...
Nen: `docs/runbooks/AGENT_RUNBOOK.md` muc 0.2. Cua so DEV = **48 thang 2022-01-01 -> 2025-12-31**
...
(he so 1.21 = ty le `edge5` GPU-vs-CPU tren nen between-seed, `docs/ops/BENCH_DEVICE.md` muc 4.2),
