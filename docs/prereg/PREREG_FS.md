...
co truoc moi commit ket qua (`docs/result/FS_RESULT.md`). Neu thu tu commit nguoc lai => toan bo ket qua
bi coi la VOID.
...
2. Hai feature OI dung tren du lieu **da chung minh ro ri 5 phut** voi moi `ts >= 2024-03-04`
   (`docs/ops/OI_SCOPE_REPORT.md`) — 19.0% tick OOS bi nhiem. Dat ung vien canh mot base bi nhiem
   la tron hai nguon sai lech.
3. Toan bo thi nghiem tro thanh **khong can metrics** => bat ky ung vien thang cung mo duong lui
   DEV ve 2020-01 (`docs/data/DATA_EXTENT_SURVEY.md` muc 2: metrics chan cung o 2021-12-01,
...
Block-bootstrap theo `docs/prereg/PREREG_CI.md` muc 3:
...
5. Do 16 ung vien, moi diem ket qua ghi **1 dong jsonl + `fsync` ngay** (Kaggle kill 12h —
   `docs/runbooks/KAGGLE_RULES.md` muc 2).
6. Viet `docs/result/FS_RESULT.md` theo dung 5 truong hop muc 6.
...
- Khong cham `docs/prereg/PREREG_GS.md`, `/home/ubuntu/gs/`, `/home/ubuntu/g015/`, `/home/ubuntu/tick/`,
