...
`docs/audit/CI_REAUDIT.md`. Neu thu tu commit nguoc lai => toan bo ket qua CI_REAUDIT bi coi la VOID.

Ly do ton tai: `docs/analysis/LEAK_L1_REPORT.md` (Cau 2/Cau 3) chung minh moi phat bieu "y nghia thong ke"
...
4. Viet `docs/audit/CI_REAUDIT.md` theo dung 3 phan loai o §4.
...
- Khong cham `docs/prereg/PREREG_GS.md`, `/home/ubuntu/gs/`, `research/kaggle/gsearch/*`.
