...
(`docs/experiment/F4_TIMING.md`). Chi DO DAI LICH SU mua duoc power, do min hon thi khong.
...
- **No ky thuat duoc ghi nhan, KHONG duoc giau**: `predwf_G015x26` la bins **khong tai lap
  duoc** (`docs/result/G015CUT_RESULT.md`). Muon chuyen sang G015_v2 thi phai **do lai TOAN BO
...
CI: bootstrap khoi 72h, nhan **1.21** (he so `docs/prereg/PREREG_CI.md` / `F4_TIMING.md`).
