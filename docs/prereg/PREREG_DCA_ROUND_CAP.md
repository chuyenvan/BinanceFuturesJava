...
x1.21, 2000 rep, seed 20260905 — `docs/runbooks/RISK_APPETITE.md`).
...
- `getDCA` duoc goi 2 cho trong `SimulatorMarketLevelTicker1MStopLoss` (nhanh `levelChange != null`
  ...
  hoat CA HAI nhanh** (coupling da do o `docs/diag/DIAG_DCA_GUARD_COUPLING.md` muc 3). Sau moi nhanh con
...
6. Viet `docs/result/RESULT_DCA_ROUND_CAP.md` + commit (KHONG push).
