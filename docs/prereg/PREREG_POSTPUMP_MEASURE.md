...
Noi tiep `docs/diag/DIAG_ALT_IDIOSYNCRATIC_RISK.md` (commit `d02c7aa`): trong cua so UW dai nhat,
...
- Ket qua ghi `docs/result/RESULT_POSTPUMP_MEASURE.md` (bang a/b/c/d + ket luan + gioi han).
