...
> Nen: `docs/audit/AUDIT_GATE_DYN_PARITY.md` (3a36f02) muc 5.2 huong **C**.
> Khung cham: `docs/prereg/PREREG_X1.md` muc 4-7 + `docs/runbooks/AGENT_RUNBOOK.md` muc 0.
...
- CI: paired block-72h bootstrap, 2000 rep, seed 20260905, nhan **1.21** (`docs/prereg/PREREG_CI.md`).
