...
`docs/result/G015CUT_RESULT.md` (commit 516e6eb) do duoc: bins G015 dang deploy
...
6. Backup bins len Kaggle dataset PRIVATE. Ghi `docs/result/G015REBUILD_RESULT.md`. Cap nhat project memory.
