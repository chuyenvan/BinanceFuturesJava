...
Bối cảnh: `docs/result/RESULT_OI_STUDY.md` (commit `745d722`) đã đo **`oi_delta24h` + `oi_z`** ⇒ H1 NO-GO,
...
## 5. Output
`docs/prereg/PREREG_LS_TAKER.md` (file này) + `docs/result/RESULT_LS_TAKER.md` + script
