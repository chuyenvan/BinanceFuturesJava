...
(`docs/experiment/G015_PROVENANCE.md`, `predwf_G015_v2/`). Nhung **G015 KHONG phai model ma C2b dung**.
...
khop). KHONG rebuild OI (code hien tai gay leak — `docs/ops/OI_FIX_LOG.md`).
...
3. So bins r1 vs deploy `predwf_map_s1a2/` vs backup Kaggle. Ghi `docs/experiment/S1_PROVENANCE.md` +
