...
(xem `docs/experiment/FEAT40_LOOKAHEAD.md` Cau 2 -- 40/40 feature Tool1 f0..f39 da co cong thuc + file:line,
...
`docs/result/RESULT_5MGRID.md`). Dung nguyen `research/pipeline/g015_net_train.py` (duong build feature
memory-light da duoc xac minh byte-identical, xem `docs/experiment/G3_X26_RECOVERY.md` muc 6.1) + them **1**
...
- **Stage 0 (`G015ABL0`, CONTROL -- BAT BUOC, phat hien SAU KHI viet ban dau cua file nay)**:
  ...
  `g015_net_train.py` dung cho Stage 1/2. **Ly do bat buoc**: doi chieu `docs/experiment/G4_RECIPE_C4.md`
  ...
  RETRAIN-NOISE von co. **Theo dung tien le da lap `docs/ops/BENCH_DEVICE.md` muc 7.4** ("hieu ung phai
...
- **Cong hoi quy Stage 0 (thay the "sha_bin giong het" da SAI o ban dau)**: fold 20240101 cua
  ...
  (khop nen nhieu multi-seed da do o `docs/experiment/G4_RECIPE_C4.md` muc 2: 0.984931-0.986678). Ngoai dai
