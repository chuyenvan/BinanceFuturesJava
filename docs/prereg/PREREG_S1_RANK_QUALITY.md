...
**Tai su dung DUNG phuong phap do cua `docs/prereg/PREREG_TREND_RANK_IC.md` (commit `e26e3c3`)
+ `docs/result/RESULT_TREND_RANK_IC.md` (commit `8591f47`)** de so sanh duoc. Khong tu nghi ra
phuong phap moi.
...
- S1 score = `-pred`, voi `pred = P(win)` (xem `docs/design/C2B_SPEC.md:101`: `score = -pred`).
...
- (ii) **trend/mom/vol da do truoc**: tai su dung bang muc 3 cua `docs/result/RESULT_TREND_RANK_IC.md`
