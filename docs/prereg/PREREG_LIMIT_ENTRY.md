...
- **C1 = REVERSAL-BOUNCE** (`docs/result/RESULT_REVERSAL_BOUNCE.md`; trigger khoá nguyên bản `PREREG_REVERSAL_BOUNCE.md`,
  commit `a68dc88`): DEV net −0,080% vs raw +0,22% (ALL +0,31%) ⇒ **đúng tiêu chí**. **Ứng viên CHÍNH.**
- **C2 = BIG_UP** (`docs/result/RESULT_BIGUP_MEDIUPDOWN.md`; trigger khoá nguyên bản `PREREG_BIGUP_MEDIUPDOWN.md`,
...
| File | Nội dung |
|---|---|
| `docs/prereg/PREREG_LIMIT_ENTRY.md` | file này (chốt trước) |
| `docs/result/RESULT_FUNDING_SIGN.md` | Phần 1 — truy vết + đo lại 2 tầng + chốt quy ước + số đúng |
| `docs/result/RESULT_LIMIT_ENTRY.md` | Phần 2 — tỉ lệ khớp, 4 hàng chi phí, CI/null/MDE, adverse selection, kết luận |
