...
Doc kem: `docs/experiment/G015_RECIPE.md` (recipe net015), `docs/experiment/G4_RECIPE_C4.md` (C4 — gia tri load-bearing o GATE),
`docs/experiment/G3_X26_RECOVERY.md`, `docs/experiment/T1_LABEL3.md` (T1 — doi nhan o tang SELECTOR), `docs/runbooks/AGENT_RUNBOOK.md`.
