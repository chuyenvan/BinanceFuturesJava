...
`research/analysis/intraday_dd.py`. Ket qua: `docs/result/RESULT_INTRADAY_DD.md`.

## 0. Dong co (phat hien that, khong phai gia thuyet)

`docs/result/RESULT_BLACKSWAN_2510.md` (commit `8bcd806`): trong cua so `2025-10-09..13`, **max drop equity
