...
Truoc do:
- `docs/result/RESULT_POSTPUMP_MEASURE.md` (`058ecb5`): `mom30d` (momentum 30 ngay tai entry) **NULL** —
  CI chua 0, bucket khong don dieu, loc lam PnL rong XAU DI o ca 3 nguong.
- `docs/diag/DIAG_ALT_IDIOSYNCRATIC_RISK.md` (`d02c7aa`): 49 lenh SUP (`profit <= -20%`) = 72% tong lo;
