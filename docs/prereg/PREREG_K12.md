...
`docs/result/F1_FLOW_RESULT.md` da quet K=8/16/24/32 tren C2b (TRUOC 3 fix B1/B2/B3, DCA off) va
...
Re-run `X1_C3_FULL` (K=8) tren dataset build moi phai khop `docs/experiment/X1_EXTEND.md` muc 9:
...
chat luong. CI: bootstrap khoi 72h, he so nhan **1.21** (`docs/prereg/PREREG_CI.md`/`F4_TIMING.md`).
