...
Vong truoc (`docs/result/RESULT_DCA_ROUND_CAP.md`) ket luan: tran **FLOW** (margin moi mo moi luot DCA) KHONG
...
CI, bootstrap block-72h x1.21, 2000 rep, seed 20260905 — `docs/runbooks/RISK_APPETITE.md`).
...
6. Viet `docs/result/RESULT_DCA_AGG_PERCOIN.md` + cap nhat `docs/runbooks/RISK_APPETITE.md` (them tap trung 1 coin <= 15%).
7. Commit (KHONG push).
