...
`docs/result/RESULT_FRAGILITY_N.md` (commit `4850b03`) kết luận: khi đánh **1x** (đã xác nhận `lv=1.0000`
...
`docs/result/RESULT_DCA_AGG_PERCOIN.md` (nền LOOSE, conc 17.15% → 12.51%, binding 45, **0 rate XAU**).
...
|---|---|---|
| **P1 parity** | `cc-par1` (x1_gs_t170, cap **OFF**) md5 **`efb793e2468ca3a7318da0f0ad23d4fc`**, n=1089, eq 111,070 | DỪNG, báo RO (`docs/runbooks/KAGGLE_SIM.md` §0) |
...
- **CI**: block-72h, **2000 rep**, seed **20260905**, anchor **2021-07-01**; báo **CẢ HAI** độ
  ...
  **k = 3** (`1.482304`, `docs/audit/AUDIT_CI_INFLATE_STANDARDIZATION.md`).
