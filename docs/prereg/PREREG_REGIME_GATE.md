...
`docs/diag/DIAG_UW_SOURCE.md` (commit `9b10742`, TASK B2 Bước 1) — UW của gate-1.0 (248 ngày) nằm
...
— không phải nhánh khác, không bị revert). Hồ sơ cũ: `docs/prereg/PREREG_REGIME_GATE.md` /
`docs/result/RESULT_REGIME_GATE.md` (bản 2026-09-14, nội dung được thay thế bởi file này — lịch sử cũ
...
9. `docs/result/RESULT_REGIME_GATE.md` (thay thế bản 2026-09-14, giữ tham chiếu ở §0 phía trên) với
