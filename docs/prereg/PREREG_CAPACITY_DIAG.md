...
Nguon: brief Uni 2026-09-23 + `docs/result/RESULT_EXIT_FIT.md` (commit `8f3194f`, `eb4c0de`),
`docs/result/TICKLOG_RESULT.md`, `docs/result/RESULT_TRAIL_LADDER.md`, `docs/result/RESULT_TRAIL_HINGE.md`.
...
| `docs/result/TICKLOG_RESULT.md` (+ `tick.bin.gz` tai `/home/ubuntu/tick/{C2b_TLON,R5_TL,R6_TL}/`) | **phan ra quyet dinh tung phut-ung-vien theo LY DO** (`D_GATE_REJECT`, `D_ALREADY_OPEN`, `D_NO_BUDGET`, `D_TOPK_CUT`, `D_ENTERED`, `D_GRID_EXHAUSTED`, `D_NO_TICKER`) | profile **C2b** (khac T170), DEV 2022-01..2024-06 |
...
`docs/result/RESULT_CAPACITY_DIAG.md` (+ trung gian `/home/ubuntu/capdiag/`). Commit, **khong push**.
