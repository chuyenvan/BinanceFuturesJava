...
Commit nay phai co truoc `docs/experiment/T1_LABEL3.md`. CHI DEV (2022-01..2024-06). Khong cham
VALIDATION/HOLDOUT. Khong rebuild OI. Output ra duong MOI.

## 0. Vi sao co job nay

`docs/result/LABELH_RESULT.md` da so 3 nhan selector nhung **DUNG o rank-IC** — khong sinh bins,
...
= **1.000000** (`docs/result/FS_RESULT.md` + `LABELH PHA A` da dat dung tri nay tren 774,270 dong).
...
`910f1aa6f76b5e6797d97a31a7ea5f5a` (`docs/runbooks/KAGGLE_SIM.md §1`).
...
**f = 1.21** (`docs/result/COV_RESULT.md`).
...
GPU tu no nhieu gap 4.8 lan — `docs/ops/BENCH_DEVICE.md`). Khong xoa file cua user.
...
9. Rate §6 + rang buoc §7 + phan quyet §8. 10. `docs/experiment/T1_LABEL3.md` + `docs/plan/QUEUE.md` + commit.
