...
(đúng `docs/runbooks/AGENT_RUNBOOK.md` luật 2; thứ tự commit ngược ⇒ kết quả **VOID**).
Quan hệ với vòng trước: `docs/prereg/PREREG_FUNDING_TOPK_ROTATE.md` (**commit `55b8280`**) +
`docs/result/RESULT_FUNDING_TOPK_ROTATE.md` (**commit `fdf61d7`**) đã đo **K = {5, 10, 20}** ⇒ **NO-GO cả 3**.

Trạng thái: **ĐANG CHỜ ĐO** (kết quả ⇒ `docs/result/RESULT_FUNDING_TOPK_K13.md`).
...
`docs/prereg/PREREG_FUNDING_TOPK_ROTATE.md` §3–§6 + `docs/result/RESULT_FUNDING_TOPK_ROTATE.md` §1 (neo MOM15 7/7 khớp).
...
- Kết quả: `docs/result/RESULT_FUNDING_TOPK_K13.md` — bảng **đầy đủ K ∈ {1,3,5,10,20}** + turnover + cost drag +
