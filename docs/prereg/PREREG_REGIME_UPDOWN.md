...
(`docs/result/RESULT_REGIME_GATE.md`, commit `54d9cdb`) da test up->1.0/down->1.70 theo MA200-trailing:
cuu duoc bear 2022 (R=T170 gan nhu tuyet doi nam do) nhung VO UW-2025 (up-gate=1.0 qua long cho
bull-nhieu 2025). Chan doan UW-2025 (`docs/diag/DIAG_UW2025_SOURCE.md`, 0-sim) xac dinh nguon 2025 la
...
— KHONG can chay lai R, so cu (`docs/result/RESULT_REGIME_GATE.md`) van dung duoc nguyen ven.
...
- **R** (up=1.0, down=1.7) — dung lai nguyen `X1_C3_FULL_2021_REGIME_R` va so tu
  `docs/result/RESULT_REGIME_GATE.md` (khong chay lai).
...
1.4(RA14)}. 9. Viet `docs/result/RESULT_REGIME_UPDOWN.md` voi phan quyet CHI cho RA12 (RA14 chi mo ta,
