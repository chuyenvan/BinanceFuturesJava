...
Trạng thái: **ĐANG CHỜ ĐO** (khi xong ⇒ `docs/result/RESULT_FUNDING_TOPK_LONG.md`).
...
(`docs/result/RESULT_FUNDING_SIGN.md`): **`rate > 0` ⇒ LONG TRẢ, SHORT THU**. Long coin funding cao ⇒
...
| File | Nội dung |
|---|---|
| `docs/prereg/PREREG_FUNDING_TOPK_LONG.md` | file này (chốt trước, commit TRƯỚC khi đo) |
| `docs/result/RESULT_FUNDING_TOPK_LONG.md` | kết quả + kết luận GO/NO-GO |
