...
> **Pre-reg TRUOC khi chay.** Thuc hien sau `docs/result/RESULT_PUMPDUMP_OHLCV.md` (commit `8a4e5f0`).
...
- Nguong BANG CHUNG: >= 2 rate ngoai CI cung huong tot. Nguong RUI RO: `docs/runbooks/RISK_APPETITE.md`.
