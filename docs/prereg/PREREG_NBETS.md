...
nay PHAI co truoc commit cua `docs/result/NBETS_RESULT.md`. Neu thu tu nguoc lai => `NBETS_RESULT.md`
bi coi la VOID.

Ly do ton tai: `docs/audit/CI_REAUDIT.md` muc (iii) va `docs/data/DATA_EXTENT_SURVEY.md` §3 ket luan
...
- KHONG sua `docs/prereg/PREREG_CI.md` hay bat ky `PREREG_*.md` cua nguoi khac.
...
5. Viet `docs/result/NBETS_RESULT.md`, mo dau bang muc "TRA LOI CHO UNI" 8-10 dong.
