...
> `docs/result/RESULT_5MGRID.md` muc 0). S1 van train lai day du o 5 phut nhu ke hoach goc.
...
> cua file nay la BAN GOC, giu nguyen de doi chieu; xem `docs/result/RESULT_5MGRID.md` cho
...
6. ⚠️ Train tren Kaggle GPU (khong phai Oracle) -- theo dung `docs/ops/BENCH_DEVICE.md`: GPU
...
- bins moi (`predwf_map_s1a2_15m_gpu`) chay qua `run_x1_sim.sh`-style, PHAI byte-identical
  hoac gan-nhu voi `X1_C3_FULL_PARITY` da co (`docs/result/K12_RESULT.md`: equity 111,428,
