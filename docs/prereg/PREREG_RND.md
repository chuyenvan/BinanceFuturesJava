...
Nguồn: `docs/design/C2B_SPEC.md` mục 0 + `docs/experiment/FEAT40_LOOKAHEAD.md`.
...
`docs/audit/AUDIT_APPLIED.md` Bảng 2 mục 3 từng viết: *"RND1 −387 / RND2 −544 USDT ⇒ mất thật 0.4-0.5pp
CAGR; pre-reg viết 'không mất gì' là sai"*. Đo lại bằng block-bootstrap ghép cặp
(`docs/prereg/PREREG_CI.md` → `docs/audit/CI_REAUDIT.md`):
...
**sau khi wave-1 kết thúc**. Ghi trong `docs/ops/RUNS_DEV.md`.
