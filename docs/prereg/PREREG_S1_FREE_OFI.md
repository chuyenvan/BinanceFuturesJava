...
`docs/result/RESULT_S1_FREE_OFI.md`; neu nguoc lai ket qua VO HIEU. Toan bo tinh toan THAT
...
`docs/plan/PROPOSAL_MICROSTRUCTURE_DATA.md` muc 6 de xuat: `data.binance.vision` bulk
...
| Baseline | **TAI SU DUNG** `pred_baseline18_n1_kaggle.parquet` (edge5 = **15.209468%**,
  ...
  `docs/result/RESULT_S1_DETERMINISM.md`) — KHONG train lai, va **TUYET DOI KHONG doi chieu voi
  baseline Oracle** (15.012825%, khac kien truc CPU aarch64 vs x86_64, lech +0.197pp
  KHONG loai duoc bang cau hinh — `docs/result/RESULT_S1_DETERMINISM.md` muc 4-5). |
...
- **Nested SELECT(fold 0-9, 2021Q3→2023Q4)/CONFIRM(fold 10-17, 2024Q1→2025Q4)**: SELECT
  chi de tham khao (theo bai hoc `docs/prereg/PREREG_S1_NOISE_CAL.md` — SELECT la
...
6. Ap luat quyet dinh muc 4.1. Viet `docs/result/RESULT_S1_FREE_OFI.md`.
