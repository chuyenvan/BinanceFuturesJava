...
Bao cao se o `docs/experiment/X3_RANKCAP_SL50.md`.
...
⚠️ Truoc fix B1 (`docs/experiment/C3_BASELINE.md`) nhanh STRONG **chua bao gio chay** — 100% WEAK. Toan bo
...
**Dong co cua X3 KHONG den tu outcome X2.** No den tu mot **phep do doc lap**: `docs/plan/HOLD_TO_DIE.md`
...
- **Quy tac thoat**: neu duong Kaggle con vuong **qua 1 gio** (upload bundle 48 thang / mount / slot),
  **chuyen sang chay TUAN TU tren Oracle va ghi ly do vao bao cao muc "sai lech so voi de bai"**.
  Khong kep o do. Ket qua khong doi: Kaggle+`file` == Oracle+`file` byte-for-byte (`docs/runbooks/KAGGLE_SIM.md` muc 1).
