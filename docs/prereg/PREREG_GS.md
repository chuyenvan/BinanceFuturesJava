...
Nguon: `docs/audit/CI_REAUDIT.md` (commit `a396797`), phuong phap chot truoc o `docs/prereg/PREREG_CI.md`
(commit `2493eca`).
...
Nguon: `docs/prereg/PREREG_PAIRED.md` (commit `c96ddb3`, tien dang ky truoc khi do) va
`docs/ops/PAIRED_CALIB.md` (commit `43467b1`, ket qua hieu chuan).
...
1. **Tinh dung cua du lieu** — xem `docs/experiment/FEAT40_LOOKAHEAD.md` va `docs/ops/OI_SCOPE_REPORT.md`.
...
> **DINH CHINH 2026-09-03 (chi THEM — khong doi luat nao o §4/§9/§10/§11/§12.1-12.3):** muc 1 ("tinh dung cua du lieu") van dung nhung **thu hep** — **file OI dang dung** (`claudedata/oi/oi_percoin_full.bin`) da duoc do lai bang gia tri va **KHONG ro ri** (taker nhan qua **450/450** mau; **0/259** symbol co ts `2024-03-04 00:00`), nen `docs/ops/OI_SCOPE_REPORT.md` / `docs/experiment/FEAT40_LOOKAHEAD.md` ban cu doc **SAI** cho pham vi nay va moi so trong file nay **khong doi**; rui ro con lai la **rebuild file OI bang code hien tai** (`VisionMetricsClient.parseDay`) se tao leak — xem `docs/ops/OI_FIX_LOG.md`.
...
Nguon: `docs/result/FS_RESULT.md` (commit `c14107a`, `3257d75`), do doc lap tren 2 moi truong CPU.
...
- **Them du lieu**: `docs/data/DATA_EXTENT_SURVEY.md` — metrics chi co tu 2021-12-01; toi da moi byte
  (2020-01..2025-12, 6 nam) cho MDE80 **4.64pp** (exit) / 8.04pp (selector). Khong dat 3pp.
- **Log quyet dinh tung tick**: `docs/result/TICKLOG_RESULT.md` — ha tang chay dung (ca 2 cong
