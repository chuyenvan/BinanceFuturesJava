...
`docs/result/RESULT_PACING_BIGDOWN.md`/`docs/result/RESULT_REGIME_GATE.md`).
...
(`docs/prereg/PREREG_REGIME_GATE.md` muc 3) tu 2 diem neo trong DUNG cua so 2021-07-01..2025-12-31:
...
`docs/prereg/PREREG_DD_THROTTLE.md` (file nay, muc 2 co che + D/floor + bien the + u1-u4 + du bao muc 1
...
`docs/result/RESULT_DD_THROTTLE.md` verdict + doi chieu du bao muc 1 -> commit code+doc branch `module`
