...
`docs/result/RESULT_S1_HPO_BAG_FEATGRP.md`; nếu thứ tự commit ngược lại thì toàn bộ kết quả VÔ HIỆU.
...
`docs/result/RESULT_S1_OI12.md` §6 (16-fold ALL **+15.41%**, 2021 2-fold **+7.545%**) trong `±0.05pp`.
...
- Hiệu chỉnh nhiều-ứng-viên: `inflate(k) = sqrt(2*ln k)` nếu `k>=2`, `= 1.0` nếu `k=1`
  (công thức chuẩn theo `docs/audit/AUDIT_CI_INFLATE_STANDARDIZATION.md` §1, KHÔNG dùng hằng số lịch
...
7. Viết `docs/result/RESULT_S1_HPO_BAG_FEATGRP.md`: phán quyết P1/P2/P3 (THẮNG/NULL/THUA), bảng
