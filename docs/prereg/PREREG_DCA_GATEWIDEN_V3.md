...
nguong/cooldown cua V1/V2 — huong do DA DONG (docs/result/RESULT_DCA_SIGNAL_GATE_V2.md muc 11).
...
Co so tu chinh du an (`docs/analysis/ANALYSIS_T170_VS_T100.md`, commit 8878a96): quan the marginal (T100-only, bi
...
`docs/result/RESULT_REGIME_GATE.md`: noi gate MOT MINH (scale 1.00 luc BTC-30d UP, 1.70 con lai) => **UW no tu 92
