...
Ngay 2026-09-12. Tiep noi `docs/audit/AUDIT_SELECTOR_MODEL_PARITY.md` (master duyet GO).
...
- (d) **admit rate**: khi symbolPred = net015-raw, admit top-8 ~2% (tu 20.49% cua
  Funding_Classifier), dyn_thr khop net015 (`docs/audit/AUDIT_SELECTOR_MODEL_PARITY.md` 2.4).
