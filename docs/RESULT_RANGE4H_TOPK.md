...
Ngày: 2026-09-22. Pre-reg: `docs/PREREG_RANGE4H_TOPK.md` (**commit `62e01bf`**, chốt TRƯỚC khi chạy;
...
`docs/SURVEY_OLDCODE_SIGNALS.md` (các rule momentum/breakout ngắn hạn không sống qua chi phí).
