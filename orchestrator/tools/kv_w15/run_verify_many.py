#!/usr/bin/env python3
# run_verify_many.py - VerifyOneWindow cho danh sach WINDOWS co dinh, TS_RATCHET_DECOUPLED=true.
# Thay the WfoWorker/fanout dang bug (xem EXIT_MACHINE PHAN 5). Moi window in 1 dong RESULT_JSON.
import glob, os, shutil, subprocess, sys

IN = "/kaggle/input"
WORK = "/kaggle/working"
WINDOWS = ["15"]
RATCHET_DECOUPLED = "true"
