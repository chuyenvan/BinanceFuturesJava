...
//import com.binance.chuyennd.research.DcaHelper;
...
//                            || orderInfo.marketLevelChange.equals(MarketLevelChange.MEDIUM_DOWN)) {
...
//                                    && (orderInfo.dynamicTP_SL == null || orderInfo.dynamicTP_SL < 1)) {
...
//        if (orderInfo == null) {
//            if (levelChange != null) {
//                if ((BudgetManagerSimple.getInstance().isAvailableTrade() && orderRunning.size() <= 20)
