 ...
 * @author pc
 */
public class OrderTradingManager {

    public static final Logger LOG = LoggerFactory.getLogger(OrderTradingManager.class);
        ...
        new Thread(() -> {
            ...
            while (true) {
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(OrderTradingManager.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }).start();
    }
