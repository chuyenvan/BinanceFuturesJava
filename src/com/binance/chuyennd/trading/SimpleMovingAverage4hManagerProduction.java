...
public class SimpleMovingAverage4hManagerProduction {
    ...
    public static final String FILE_DATA_SMA4H = "storage/sma/4h.data";
    ...
    public static SimpleMovingAverage4hManagerProduction getInstance() {
        if (INSTANCE == null) {
            ...
            if (new File(FILE_DATA_SMA4H).exists()) {
                INSTANCE.symbol2MADifference10And60 = (ConcurrentHashMap<String, TreeMap<Long, Double>>)
                        Storage.readObjectFromFile(FILE_DATA_SMA4H);
            } else {
    ...
    private void updateAllSymbol() {
        ...
        Storage.writeObject2File(FILE_DATA_SMA4H,symbol2MADifference10And60);
    }
