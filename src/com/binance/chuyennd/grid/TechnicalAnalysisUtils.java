...
/**
 * Lớp tiện ích chứa các hàm để tính toán các chỉ báo phân tích kỹ thuật.
 */
public class TechnicalAnalysisUtils {

    /**
     * Enum định nghĩa các Chế độ Thị trường.
     */
    ...
    /**
     * Tính toán Simple Moving Average (SMA) từ danh sách nến.
     * @param tickers Danh sách nến.
     * @param period Chu kỳ tính SMA.
