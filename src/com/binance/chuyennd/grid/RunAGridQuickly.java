...
public class RunAGridQuickly {
    public static final Logger LOG = LoggerFactory.getLogger(RunAGridQuickly.class);
...
//        side = OrderSide.BUY;
        ...
        for (KlineObjectSimple ticker : tickers) {
            ...
            if (simulator.status.equals(OrderTargetStatus.POSITION_RUNNING)) {
                ...
                simulator.updateOrderUnique(ticker);
            } else {
