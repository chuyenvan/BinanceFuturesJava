...
class V1Trainer:
    ...
    def train(self, target_name, data_dir, n_trials):
        ...
        if "maxDrawdown" in target_name: clean_name = target_name.replace("Next", "") # Fix ten drawdown
...
if __name__ == "__main__":
    ...
    parser.add_argument('--trials', type=int, default=100) # Mac dinh 100 trials cho chat luong
