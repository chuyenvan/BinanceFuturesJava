# deploy/shadow_c3 — bản tham chiếu triển khai Shadow C3 (T170 paper)
...
- **Paper only**: `SHADOW_NO_PUSH=true` (hardcode trong `LiveProfileC3` + đặt lại trong env.sh).
  TUYỆT ĐỐI không tắt.
- **T170**: gate `SIM_GATE_DYN_SCALE=1.70`, `SELECTOR_ONLY_ENTRY=0`, DCA grid
  `1,1,3,8` / scale `19.5`, loser time-stop 168h. Nguồn chuẩn `profiles/x1_gs_t170.properties`.
