...
- Bước: (1) 🔄 export bù 1332 ngày (ExportHpoDataKaggle, log ~/claudedata/export_ticker_full.log);
  (2) upload dataset `chuyendinh/hpo-ticker-daily`; (3) kiểm path logic KaggleDataLoader.loadObject với
  mount layout mới /kaggle/input/datasets/... (rule §3b — có thể phải sửa glob); (4) kernel worker chế độ
